package cn.ibizlab.ibizodoo.mail.mailtemplate.logic
...
/**
 * 实体[MAIL_TEMPLATE]处理逻辑[刷新消息模板缓存]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class RefreshCache extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(RefreshCache.class)
