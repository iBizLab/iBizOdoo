package cn.ibizlab.ibizodoo.mail.fetchmailserver.logic
...
/**
 * 实体[FETCHMAIL_SERVER]处理逻辑[重置确认]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class SetDraft extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(SetDraft.class)
