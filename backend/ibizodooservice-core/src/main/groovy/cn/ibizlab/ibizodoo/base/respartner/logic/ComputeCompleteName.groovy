...
/**
 * 实体[RES_PARTNER]处理逻辑[计算全名]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class ComputeCompleteName extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ComputeCompleteName.class)
