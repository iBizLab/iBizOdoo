package cn.ibizlab.ibizodoo.base.resusers.logic
...
/**
 * 实体[RES_USERS]处理逻辑[cloud用户同步]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class SyncCloudUser extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(SyncCloudUser.class)
    ...
    /**
     * 执行逻辑节点[设置关联ID]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[检查cloud用户数据]，逻辑类型[DEACTION]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[同步建立cloud用户]，逻辑类型[DEACTION]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
