package cn.ibizlab.ibizodoo.hr.hrdepartment.logic
...
/**
 * 实体[HR_DEPARTMENT]处理逻辑[部门计数器]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class DepartmentCounter extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(DepartmentCounter.class)
    ...
    /**
     * 执行逻辑节点[初始化数量]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
