package cn.ibizlab.ibizodoo.mail.mailalias

import java.util.List
import org.springframework.data.domain.Page

import cn.ibizlab.ibizodoo.mail.mailalias.dto.*
...
class MailAlias extends GroovyDataEntityRuntime<MailAlias,MailAliasDTO,MailAliasFilterDTO> {
    ...
    Page<MailAliasDTO> fetchDefault(MailAliasFilterDTO context) throws Throwable {
        return this.fetch(DATASET_DEFAULT, context, MailAliasDTO.class)
    }
