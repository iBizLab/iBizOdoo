...
/**
 * 实体[DISCUSS_CHANNEL]处理逻辑[新建后加入频道]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class FillDefaultMember extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(FillDefaultMember.class)
    ...
    /**
     * 执行逻辑节点[准备默认用户]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
