package cn.ibizlab.ibizodoo.mail.mailthread.logic
...
/**
 * 实体[MAIL_THREAD]处理逻辑[message_post_with_source]运行时对象
 * 此代码用户功能扩展代码
 *
 * //TODO
待完善带模板转换消息发送逻辑，目前简单构造消息并新建
 */
class MessagePostWithSource extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(MessagePostWithSource.class)
    ...
    /**
     * 执行逻辑节点[构造消息对象]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
