...
/**
 * 实体[HR_EMPLOYEE]处理逻辑[准备默认用户数据对象]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class PrepareDefaultUser extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(PrepareDefaultUser.class)
