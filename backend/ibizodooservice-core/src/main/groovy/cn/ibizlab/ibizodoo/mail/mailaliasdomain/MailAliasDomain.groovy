package cn.ibizlab.ibizodoo.mail.mailaliasdomain

import java.util.List
import org.springframework.data.domain.Page

import cn.ibizlab.ibizodoo.mail.mailaliasdomain.dto.*
...
class MailAliasDomain extends GroovyDataEntityRuntime<MailAliasDomain,MailAliasDomainDTO,MailAliasDomainFilterDTO> {
    ...
    Page<MailAliasDomainDTO> fetchDefault(MailAliasDomainFilterDTO context) throws Throwable {
        return this.fetch(DATASET_DEFAULT, context, MailAliasDomainDTO.class)
    }
