package cn.ibizlab.ibizodoo.hr.hrleave

import java.util.List
import org.springframework.data.domain.Page

import cn.ibizlab.ibizodoo.hr.hrleave.dto.*
...
class HrLeave extends GroovyDataEntityRuntime<HrLeave,HrLeaveDTO,HrLeaveFilterDTO> {
    ...
    Page<HrLeaveDTO> fetchDefault(HrLeaveFilterDTO context) throws Throwable {
        return this.fetch(DATASET_DEFAULT, context, HrLeaveDTO.class)
    }
