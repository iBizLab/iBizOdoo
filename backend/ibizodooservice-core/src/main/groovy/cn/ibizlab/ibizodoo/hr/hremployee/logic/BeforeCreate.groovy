package cn.ibizlab.ibizodoo.hr.hremployee.logic
...
/**
 * 实体[HR_EMPLOYEE]处理逻辑[建立之前]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class BeforeCreate extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(BeforeCreate.class)
    ...
    /**
     * 执行逻辑节点[准备联系人对象]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[回填work_contact_id]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
