package cn.ibizlab.ibizodoo.mail.mailalias.dto
...
class MailAliasDTO extends GroovyDTO<MailAliasDTO> {
     ...
     * @param val
     */
    MailAliasDTO setAliasModelId(String aliasModelId) {
     ...
     * @param val
     */
    MailAliasDTO setAliasParentModelId(String aliasParentModelId) {
     ...
     * @param val
     */
    MailAliasDTO setAliasDomainName(String aliasDomainName) {
