package cn.ibizlab.ibizodoo.base.avatarmixin.logic
...
/**
 * 实体[AVATAR_MIXIN]处理逻辑[存储头像]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class SaveAvater extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(SaveAvater.class)
