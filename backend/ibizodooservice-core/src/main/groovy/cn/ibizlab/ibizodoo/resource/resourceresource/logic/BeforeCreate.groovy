package cn.ibizlab.ibizodoo.resource.resourceresource.logic
...
/**
 * 实体[RESOURCE_RESOURCE]处理逻辑[建立之前]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class BeforeCreate extends DELogicRuntime {
    ...
    /**
     * 执行逻辑节点[回填user_id]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
