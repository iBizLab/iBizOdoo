package cn.ibizlab.ibizodoo.base.respartner.logic
...
/**
 * 实体[RES_PARTNER]处理逻辑[计算显示名称]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class ComputeDisplayName extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ComputeDisplayName.class)
    ...
    /**
     * 执行逻辑节点[赋值显示名称]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
