package cn.ibizlab.ibizodoo.base.irattachment

import java.util.List
import org.springframework.data.domain.Page

import cn.ibizlab.ibizodoo.base.irattachment.dto.*
...
class IrAttachment extends GroovyDataEntityRuntime<IrAttachment,IrAttachmentDTO,IrAttachmentFilterDTO> {
    ...
    public static final String DATASET_COMMON_BY_MODEL = "common_by_model"
    ...
    Page<IrAttachmentDTO> fetchCommon(IrAttachmentFilterDTO context) throws Throwable {
        return this.fetch(DATASET_COMMON, context, IrAttachmentDTO.class)
    }
     ...
     * @throws Throwable
     */
    @DEDataSet(DATASET_COMMON_BY_MODEL)
    Page<IrAttachmentDTO> fetchCommonByModel(IrAttachmentFilterDTO context) throws Throwable {
        return this.fetch(DATASET_COMMON_BY_MODEL, context, IrAttachmentDTO.class)
    }
