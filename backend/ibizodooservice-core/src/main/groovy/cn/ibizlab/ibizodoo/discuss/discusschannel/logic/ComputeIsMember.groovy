package cn.ibizlab.ibizodoo.discuss.discusschannel.logic
...
/**
 * 实体[DISCUSS_CHANNEL]处理逻辑[计算是否是频道的成员]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class ComputeIsMember extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ComputeIsMember.class)
