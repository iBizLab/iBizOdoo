...
/**
 * 实体[HR_EMPLOYEE]处理逻辑[生成徽标 ID]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class GenerateRandomBarcode extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(GenerateRandomBarcode.class)
