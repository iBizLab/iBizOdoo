...
/**
 * 实体[DISCUSS_CHANNEL]处理逻辑[离开频道]运行时对象
 * 此代码用户功能扩展代码
 *
 * 后续还需补充退订等逻辑
 */
class Unfollow extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(Unfollow.class)
    ...
    /**
     * 执行逻辑节点[准备过滤器]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
