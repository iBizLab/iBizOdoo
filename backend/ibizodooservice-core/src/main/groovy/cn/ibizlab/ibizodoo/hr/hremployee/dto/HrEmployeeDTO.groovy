package cn.ibizlab.ibizodoo.hr.hremployee.dto
...
class HrEmployeeDTO extends GroovyDTO<HrEmployeeDTO> {
     ...
     * @param val
     */
    HrEmployeeDTO setContractId(String contractId) {
     ...
     * @param val
     */
    HrEmployeeDTO setDepartureReasonId(String departureReasonId) {
     ...
     * @param val
     */
    HrEmployeeDTO setLastAttendanceId(String lastAttendanceId) {
