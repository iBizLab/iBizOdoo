...
/**
 * 实体[HR_EMPLOYEE]处理逻辑[用户变更]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class OnchangeUser extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(OnchangeUser.class)
    ...
    /**
     * 执行逻辑节点[回写work_contact_id]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
