...
/**
 * 实体[MAIL_MESSAGE]处理逻辑[取消置顶]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class Unpin extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(Unpin.class)
    ...
    /**
     * 执行逻辑节点[置空置顶时间]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
