package cn.ibizlab.ibizodoo.hr.hrleave.dto
...
class HrLeaveDTO extends GroovyDTO<HrLeaveDTO> {
     ...
     * @param val
     */
    HrLeaveDTO setCompanyId(String companyId) {
     ...
     * @param val
     */
    HrLeaveDTO setDepartmentId(String departmentId) {
     ...
     * @param val
     */
    HrLeaveDTO setEmployeeCompanyId(String employeeCompanyId) {
     ...
     * @param val
     */
    HrLeaveDTO setFirstApproverId(String firstApproverId) {
     ...
     * @param val
     */
    HrLeaveDTO setManagerId(String managerId) {
     ...
     * @param val
     */
    HrLeaveDTO setMessageMainAttachmentId(String messageMainAttachmentId) {
     ...
     * @param val
     */
    HrLeaveDTO setResourceCalendarId(String resourceCalendarId) {
     ...
     * @param val
     */
    HrLeaveDTO setSecondApproverId(String secondApproverId) {
     ...
     * @param val
     */
    HrLeaveDTO setUserId(String userId) {
        this.userId = userId
        return this
    }
