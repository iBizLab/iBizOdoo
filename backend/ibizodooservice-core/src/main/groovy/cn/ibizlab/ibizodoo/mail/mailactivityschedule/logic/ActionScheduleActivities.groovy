...
/**
 * 实体[MAIL_ACTIVITY_SCHEDULE]处理逻辑[安排]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class ActionScheduleActivities extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ActionScheduleActivities.class)
