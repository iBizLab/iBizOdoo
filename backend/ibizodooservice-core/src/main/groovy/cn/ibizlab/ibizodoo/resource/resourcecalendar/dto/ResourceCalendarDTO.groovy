package cn.ibizlab.ibizodoo.resource.resourcecalendar.dto
...
import cn.ibizlab.ibizodoo.resource.resourcecalendarattendance.dto.ResourceCalendarAttendanceDTO
...
class ResourceCalendarDTO extends GroovyDTO<ResourceCalendarDTO> {
     ...
     * @param val
     */
    ResourceCalendarDTO setActive(Integer active) {
        this.active = active
        return this
    }
     ...
     * @param val
     */
    ResourceCalendarDTO setCompanyName(String companyName) {
