package cn.ibizlab.ibizodoo.hr.hrdepartment.dto
...
class HrDepartmentDTO extends GroovyDTO<HrDepartmentDTO> {
     ...
     * @param val
     */
    HrDepartmentDTO setActivities(List<MailActivityDTO> activities) {
     ...
     * @param val
     */
    HrDepartmentDTO setAttachments(List<IrAttachmentDTO> attachments) {
     ...
     * @param val
     */
    HrDepartmentDTO setFollowers(List<MailFollowersDTO> followers) {
     ...
     * @param val
     */
    HrDepartmentDTO setActivityDateDeadline(Timestamp activityDateDeadline) {
     ...
     * @param val
     */
    HrDepartmentDTO setActivityExceptionDecoration(String activityExceptionDecoration) {
     ...
     * @param val
     */
    HrDepartmentDTO setActivityState(String activityState) {
     ...
     * @param val
     */
    HrDepartmentDTO setChildCount(Integer childCount) {
     ...
     * @param val
     */
    HrDepartmentDTO setMyActivityDateDeadline(Timestamp myActivityDateDeadline) {
