package cn.ibizlab.ibizodoo.mail.mailmessage.dto
...
import cn.ibizlab.ibizodoo.mail.mailtrackingvalue.dto.MailTrackingValueDTO
...
class MailMessageDTO extends GroovyDTO<MailMessageDTO> {
     ...
     * 「null」
     */
    @JsonProperty("mail_tracking_values")
    List<MailTrackingValueDTO> mailTrackingValues
     ...
     * @param val
     */
    MailMessageDTO setAuthorName(String authorName) {
     ...
     * @param val
     */
    MailMessageDTO setParentName(String parentName) {
     ...
     * @param val
     */
    MailMessageDTO setSubtypeName(String subtypeName) {
     ...
     * @param val
     */
    MailMessageDTO setMailTrackingValues(List<MailTrackingValueDTO> mailTrackingValues) {
        this.mailTrackingValues = mailTrackingValues
        return this
    }
