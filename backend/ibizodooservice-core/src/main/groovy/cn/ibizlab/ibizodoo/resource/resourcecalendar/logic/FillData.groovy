package cn.ibizlab.ibizodoo.resource.resourcecalendar.logic
...
/**
 * 实体[RESOURCE_CALENDAR]处理逻辑[填充资源工作时间数据]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class FillData extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(FillData.class)
