package cn.ibizlab.ibizodoo.resource.resourcemixin.logic
...
/**
 * 实体[RESOURCE_MIXIN]处理逻辑[新建逻辑]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class PrepareCreate extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(PrepareCreate.class)
    ...
    /**
     * 执行逻辑节点[准备资源数据对象]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[回填数据对象]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
