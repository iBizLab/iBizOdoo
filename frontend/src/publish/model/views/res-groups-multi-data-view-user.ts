export default {
  mdctrlActiveMode: 1,
  loadDefault: true,
  deviewCodeName: 'multi_data_view_user',
  deviewId: '117fdd68a4b861426f0ebbb4745aab0b',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.RES_GROUPS',
  },
  caption: '用户所属群组',
  codeName: 'res_groups_multi_data_view_user',
    ...
    appViewLogics: [
      {
        ...
        builtinAppUILogic: {
          ...
          newDataAppView: {
            refAppViewId: 'ibizodooapp.res_groups_main_view',
          },
          appUILogicRefViews: [
            {
              refAppViewId: 'ibizodooapp.res_groups_main_view',
    ...
    controls: [
      {
        ...
        codeName: 'multi_data_view_user_toolbar',
        controlType: 'TOOLBAR',
        ...
        name: 'toolbar',
        id: 'multi_data_view_user_toolbar',
      },
      {
        ...
        name: 'searchform',
        id: 'ibizodooapp.res_groups.main2',
      },
      {
        groupMode: 'SINGLE',
        searchBarGroups: [
        ...
        modelId: '7f943bae8bfaeb299c9047ec753882d7',
        modelType: 'PSSYSSEARCHBAR',
        name: 'searchbar',
        id: 'ibizodooapp.res_groups.search_bar_user',
      },
      {
        aggMode: 'NONE',
        ...
        modelType: 'PSDEGRID',
        name: 'grid',
        id: 'ibizodooapp.res_groups.main',
      },
      {
        capLanguageRes: {
          lanResTag: 'DE.LNAME.RES_GROUPS',
        ...
        caption: '用户所属群组',
        codeName: 'multi_data_view_user_captionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'ibizodooapp.res_groups',
        controlParam: {},
        name: 'captionbar',
        id: 'multi_data_view_user_captionbar',
      },
    ],
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '603b9e47d9a587566fe2c5c58b70675d',
  modelType: 'PSAPPDEVIEW',
  name: 'res_groupsmulti_data_view_user',
  id: 'ibizodooapp.res_groups_multi_data_view_user',
};
