export default {
  ...
  deviewId: '44b550e6a6b0771b31d8d8ddbbc37dda',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.IR_RULE',
  },
  caption: '规则',
  codeName: 'ir_rule_multi_data_view',
    ...
    appViewLogics: [
      {
        ...
        builtinAppUILogic: {
          ...
          newDataAppView: {
            refAppViewId: 'ibizodooapp.ir_rule_main_view',
          },
          appUILogicRefViews: [
            {
              refAppViewId: 'ibizodooapp.ir_rule_main_view',
    ...
    controls: [
      {
        ...
        modelId: '1cde9eaa6e4fb1e96d82bca5ad07c5af',
        modelType: 'PSDEGRID',
        name: 'grid',
        id: 'ibizodooapp.ir_rule.main',
      },
      {
        groupMode: 'AND',
        searchBarGroups: [
          {
            caption: '全局',
            data: '{"theme_model":{"searchconds":[{"condtype":"GROUP","condop":"AND","bnotmode":false,"searchconds":[{"condtype":"DEFIELD","fieldname":"global","condop":"EQ","value":"1"}]}]}}',
            itemType: 'GROUP',
            id: 'global',
          },
          {
            addSeparator: true,
            caption: '以小组为单位',
            data: '{"theme_model":{"searchconds":[{"condtype":"GROUP","condop":"AND","bnotmode":false,"searchconds":[{"condtype":"DEFIELD","fieldname":"global","condop":"EQ","value":"0"}]}]}}',
            itemType: 'GROUP',
            id: 'not_global',
          },
          {
          ...
          {
            caption: '创建',
            data: '{"theme_model":{"searchconds":[{"condtype":"GROUP","condop":"AND","bnotmode":false,"searchconds":[{"condtype":"DEFIELD","fieldname":"perm_create","condop":"EQ","value":"1"}]}]}}',
            itemType: 'GROUP',
            userParam: {
              filterorgroup: 'group1',
            },
          ...
          },
          {
            addSeparator: true,
            caption: '删除',
            data: '{"theme_model":{"searchconds":[{"condtype":"GROUP","condop":"AND","bnotmode":false,"searchconds":[{"condtype":"DEFIELD","fieldname":"perm_unlink","condop":"EQ","value":"1"}]}]}}',
            itemType: 'GROUP',
            userParam: {
              filterorgroup: 'group1',
            },
        ...
        modelId: '9f785c12430ad40e8c3eaf4a1f6e4c42',
        modelType: 'PSSYSSEARCHBAR',
        name: 'searchbar',
        id: 'ibizodooapp.ir_rule.search_bar',
      },
      {
        detoolbarItems: [
          {
        ...
        controlType: 'TOOLBAR',
        logicName: '规则实体管理视图_工具栏',
        appDataEntityId: 'ibizodooapp.ir_rule',
        controlParam: {
          id: 'toolbar',
        },
        modelId: 'c363858f1da3534dd5b84404976327c5',
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '45435acd3b639c0035105cc73fa0159d',
  modelType: 'PSAPPDEVIEW',
  name: 'ir_rulemulti_data_view',
  id: 'ibizodooapp.ir_rule_multi_data_view',
};
