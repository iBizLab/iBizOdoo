export default {
  ...
  deviewId: 'd0423c2e73eaadedfd9f126a80dd1c0c',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.FETCHMAIL_SERVER',
  },
  caption: '收件服务器',
  codeName: 'fetchmail_server_multi_data_view',
  ...
  viewLayoutPanel: {
    ...
    appViewLogics: [
      {
        ...
        builtinAppUILogic: {
          ...
          newDataAppView: {
            refAppViewId: 'ibizodooapp.fetchmail_server_main_view',
          },
          appUILogicRefViews: [
            {
              refAppViewId: 'ibizodooapp.fetchmail_server_main_view',
    ...
    appViewRefs: [
      ...
      {
        realTitle: '收件服务器',
        refAppViewId: 'ibizodooapp.fetchmail_server_multi_data_view',
        name: 'OPENDATA',
        id: 'opendata',
      },
      {
    ...
    controls: [
      ...
      },
      {
        ...
        searchBarGroups: [
          {
            caption: 'IMAP',
            data: '{"theme_model":{"searchconds":[{"condtype":"GROUP","condop":"AND","bnotmode":false,"searchconds":[{"condtype":"DEFIELD","fieldname":"server_type","condop":"EQ","value":"imap"}]}]}}',
            itemType: 'GROUP',
            userParam: {
          ...
          },
          {
            addSeparator: true,
            caption: 'POP',
            data: '{"theme_model":{"searchconds":[{"condtype":"GROUP","condop":"AND","bnotmode":false,"searchconds":[{"condtype":"DEFIELD","fieldname":"server_type","condop":"EQ","value":"pop"}]}]}}',
            itemType: 'GROUP',
            userParam: {
              filterorgroup: 'group1',
            },
          ...
          },
          {
            addSeparator: true,
            caption: 'SSL',
            data: '{"theme_model":{"searchconds":[{"condtype":"GROUP","condop":"AND","bnotmode":false,"searchconds":[{"condtype":"DEFIELD","fieldname":"is_ssl","condop":"EQ","value":"1"}]}]}}',
            itemType: 'GROUP',
            id: 'ssl',
          },
          {
        ...
        modelId: '1a69503c836f8b0c207b0ea5a7561f19',
        modelType: 'PSSYSSEARCHBAR',
        name: 'searchbar',
        id: 'ibizodooapp.fetchmail_server.search_bar',
      },
      {
        aggMode: 'NONE',
        ...
        degridColumns: [
          ...
          {
            clconvertMode: 'FRONT',
            dataItemName: 'server_type',
            excelCaption: '服务器类型',
            appCodeListId: 'ibizodooapp.mail__fetchmail_server_server_type',
          ...
          },
          {
            ...
            dataItemName: 'state',
            excelCaption: '状态',
            appCodeListId: 'ibizodooapp.mail__fetchmail_server_state',
            appDEFieldId: 'state',
            valueType: 'SIMPLE',
            aggMode: 'NONE',
            align: 'LEFT',
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: 'd820414c055dd08a88afd0ed871625f8',
  modelType: 'PSAPPDEVIEW',
  name: 'fetchmail_servermulti_data_view',
  id: 'ibizodooapp.fetchmail_server_multi_data_view',
};
