export default {
  ...
  deviewId: '20229ec58442054861a34bf0f23eb942',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.MAIL_ACTIVITY_TYPE',
  },
  caption: '活动类型',
  codeName: 'mail_activity_type_multi_data_view',
    ...
    appViewLogics: [
      {
        ...
        builtinAppUILogic: {
          ...
          newDataAppView: {
            refAppViewId: 'ibizodooapp.mail_activity_type_main_view',
          },
          appUILogicRefViews: [
            {
              refAppViewId: 'ibizodooapp.mail_activity_type_main_view',
    ...
    controls: [
      ...
      },
      {
        ...
        itemLayoutPanel: {
          ...
          appDataEntityId: 'ibizodooapp.mail_activity_type',
          controlParam: {},
          modelId: '4a2291c3801e6aca471816962844b262',
          modelType: 'PSSYSVIEWPANEL',
          name: 'itemlayoutpanel',
          id: 'ibizodooapp.mail_activity_type.mail_activity_type',
        },
        minorSortDir: 'ASC',
        ...
        autoLoad: true,
        showBusyIndicator: true,
        codeName: 'mail_activity_type_info',
        ...
        modelId: 'd67575f017cebf1d9d43a307d0129789',
        modelType: 'PSDEDATAVIEW',
        name: 'dataview',
        id: 'ibizodooapp.mail_activity_type.mail_activity_type_info',
      },
      {
        groupMode: 'AND',
        searchBarGroups: [
        ...
        modelId: 'c1214da3bc3813cec59ae134948b250b',
        modelType: 'PSSYSSEARCHBAR',
        name: 'searchbar',
        id: 'ibizodooapp.mail_activity_type.search_bar',
      },
      {
        detoolbarItems: [
          {
        ...
        controlType: 'TOOLBAR',
        logicName: '活动类型实体管理视图_工具栏',
        appDataEntityId: 'ibizodooapp.mail_activity_type',
        controlParam: {
          id: 'toolbar',
        },
        modelId: 'dbf37bd5432898db898a6f390e1d2975',
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '1dfb49b6b86aeb25ef828b8b419d5bbb',
  modelType: 'PSAPPDEVIEW',
  name: 'mail_activity_typemulti_data_view',
  id: 'ibizodooapp.mail_activity_type_multi_data_view',
};
