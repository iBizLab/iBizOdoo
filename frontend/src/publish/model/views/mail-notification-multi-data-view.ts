export default {
  ...
  deviewId: '53c7efcafaf7d71850fa29b5a1707bf3',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.MAIL_NOTIFICATION',
  },
  caption: '消息通知',
  codeName: 'mail_notification_multi_data_view',
    ...
    appViewLogics: [
      {
        ...
        builtinAppUILogic: {
          ...
          newDataAppView: {
            refAppViewId: 'ibizodooapp.mail_notification_main_view',
          },
          appUILogicRefViews: [
            {
              refAppViewId: 'ibizodooapp.mail_notification_main_view',
    ...
    controls: [
      {
        ...
        modelId: '6e6e65fab92f0d29471cfd2ecb52c2a5',
        modelType: 'PSSYSSEARCHBAR',
        name: 'searchbar',
        id: 'ibizodooapp.mail_notification.search_bar',
      },
      {
        aggMode: 'NONE',
        ...
        degridColumns: [
          {
            clconvertMode: 'NONE',
            dataItemName: 'mail_message_record_name',
            excelCaption: '消息',
            linkAppViewId: 'ibizodooapp.mail_message_main_view',
            linkValueItem: 'mail_message_id',
          ...
          {
            clconvertMode: 'FRONT',
            dataItemName: 'notification_type',
            excelCaption: '通知类型',
            appCodeListId:
          ...
          {
            clconvertMode: 'FRONT',
            dataItemName: 'failure_type',
            excelCaption: '失败类型',
            appCodeListId: 'ibizodooapp.mail__mail_notification_failure_type',
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '6fbebea4af658b3f4bf67eebf434289b',
  modelType: 'PSAPPDEVIEW',
  name: 'mail_notificationmulti_data_view',
  id: 'ibizodooapp.mail_notification_multi_data_view',
};
