export default {
  ...
  deviewId: 'd786afa710418ef33f4417b6481da3a8',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.HR_SKILL_TYPE',
  },
  caption: '技能类型',
  codeName: 'hr_skill_type_main_view',
  appDataEntityId: 'ibizodooapp.hr_skill_type',
  sysCss: {
  ...
  viewLayoutPanel: {
    ...
    controls: [
      ...
      },
      {
                ...
                deformDetails: [
                  ...
                  },
                  {
                    ...
                    deformDetails: [
                      {
                        maskMode: 0,
                        appViewId: 'ibizodooapp.hr_skill_grid_view',
                        parentDataJO: {
                          SRFPARENTTYPE: 'DER1N',
                          srfparentdename: 'HR_SKILL_TYPE',
                          srfparentmode:
                            'DER1N_HR_SKILL_HR_SKILL_TYPE_SKILL_TYPE_ID',
                          srfparentdefname: 'SKILL_TYPE_ID',
                          SRFDER1NID:
                            'DER1N_HR_SKILL_HR_SKILL_TYPE_SKILL_TYPE_ID',
                        },
                        codeName: 'druipart1',
                  ...
                  },
                  {
                    ...
                    deformDetails: [
                      {
                        maskMode: 0,
                        appViewId: 'ibizodooapp.hr_skill_level_grid_view',
                        parentDataJO: {
                          SRFPARENTTYPE: 'DER1N',
                          srfparentdename: 'HR_SKILL_TYPE',
                          srfparentmode:
                            'DER1N_HR_SKILL_LEVEL_HR_SKILL_TYPE_SKILL_TYPE_ID',
                          srfparentdefname: 'SKILL_TYPE_ID',
                          SRFDER1NID:
                            'DER1N_HR_SKILL_LEVEL_HR_SKILL_TYPE_SKILL_TYPE_ID',
                        },
        ...
        modelId: '741259aedc024692321f5c1e64a1edeb',
        modelType: 'PSDEFORM_EDITFORM',
        name: 'form',
        id: 'ibizodooapp.hr_skill_type.main',
      },
      {
        detoolbarItems: [
          {
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '63f4b3e2eb15327deb1c1ba4734d6a61',
  modelType: 'PSAPPDEVIEW',
  name: 'hr_skill_typemain_view',
  id: 'ibizodooapp.hr_skill_type_main_view',
};
