export default {
  ...
  deviewId: 'ae2d8408a2e1e633f52d8f3711640263',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'PAGE.CAPTION.HR_RESUME_LINE_TYPE.MULTI_DATA_VIEW',
  },
  caption: '简历明细类型',
  codeName: 'hr_resume_line_type_multi_data_view',
    ...
    appViewLogics: [
      {
        ...
        builtinAppUILogic: {
          ...
          newDataAppView: {
            refAppViewId: 'ibizodooapp.hr_resume_line_type_edit_view',
          },
          appUILogicRefViews: [
            {
              refAppViewId: 'ibizodooapp.hr_resume_line_type_edit_view',
    ...
    controls: [
      {
        ...
        modelId: '53ee84696b168f8fce58332f87a0d157',
        modelType: 'PSDEGRID',
        name: 'grid',
        id: 'ibizodooapp.hr_resume_line_type.edit_main',
      },
      {
        groupMode: 'AND',
        quickGroupCount: 1,
        ...
        logicName: '简历明细的类型搜索栏',
        appDataEntityId: 'ibizodooapp.hr_resume_line_type',
        controlParam: {
          id: 'searchbar',
        },
        sysPFPluginId: 'odoo_search_bar',
        modelId: '67d589f3fdc56b1844426b1b00d4e6e0',
        modelType: 'PSSYSSEARCHBAR',
        name: 'searchbar',
        id: 'ibizodooapp.hr_resume_line_type.search_bar',
      },
      {
        detoolbarItems: [
          {
        ...
        controlType: 'TOOLBAR',
        logicName: '简历明细类型实体管理视图_工具栏',
        appDataEntityId: 'ibizodooapp.hr_resume_line_type',
        controlParam: {
          id: 'toolbar',
        },
        modelId: '859f379df13fa163d143be97d7b48585',
  ...
  title: '简历明细类型',
  titleLanguageRes: {
    lanResTag: 'PAGE.TITLE.HR_RESUME_LINE_TYPE.MULTI_DATA_VIEW',
  },
  viewStyle: 'DEFAULT',
  viewType: 'DEMDCUSTOMVIEW',
  enableDP: true,
  showCaptionBar: true,
  modelId: '1ab997f8016d6d7c96d0691cae4b4f82',
  modelType: 'PSAPPDEVIEW',
  name: 'hr_resume_line_typemulti_data_view',
  id: 'ibizodooapp.hr_resume_line_type_multi_data_view',
};
