export default {
  ...
  caption: '模型访问',
  codeName: 'ir_model_access_grid_view',
    ...
    controls: [
      {
        ...
        modelType: 'PSDEGRID',
        name: 'grid',
        id: 'ibizodooapp.ir_model_access.edit_main',
      },
      {
        detoolbarItems: [
          {
      ...
      },
      {
        ...
        name: 'searchform',
        id: 'ibizodooapp.ir_model_access.default',
      },
      {
        groupMode: 'SINGLE',
        quickSearchMode: 1,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: 'aaf4a89a9c532572a5f6fcb10936eb93',
  modelType: 'PSAPPDEVIEW',
  name: 'ir_model_accessGridView',
  id: 'ibizodooapp.ir_model_access_grid_view',
};
