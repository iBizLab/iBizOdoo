export default {
  ...
  caption: '公司',
  codeName: 'res_company_multi_data_view',
    ...
    controls: [
      {
        ...
        itemLayoutPanel: {
          ...
          id: 'ibizodooapp.res_company.a1bf47c0839bd79fb26',
        },
        dedataViewDataItems: [
          {
            appDEFieldId: 'id',
        ...
        name: 'dataview',
        id: 'ibizodooapp.res_company.company',
      },
      {
        groupMode: 'AND',
        quickGroupCount: 1,
        ...
        name: 'searchbar',
        id: 'ibizodooapp.res_company.search_bar',
      },
      {
        detoolbarItems: [
          {
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '0a4218f25ec6a3c8b78ef5db6d36e528',
  modelType: 'PSAPPDEVIEW',
  name: 'res_companymulti_data_view',
  id: 'ibizodooapp.res_company_multi_data_view',
};
