export default {
  ...
  deviewId: 'b66e78c554048236828b06f59b392776',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.RESOURCE_RESOURCE',
  },
  caption: '资源',
  codeName: 'resource_resource_multi_data_view',
    ...
    appViewLogics: [
      {
        ...
        builtinAppUILogic: {
          ...
          newDataAppView: {
            refAppViewId: 'ibizodooapp.resource_resource_main_view',
          },
          appUILogicRefViews: [
            {
              refAppViewId: 'ibizodooapp.resource_resource_main_view',
    ...
    controls: [
      {
        ...
        searchBarGroups: [
          {
            caption: '人员',
            data: '{"theme_model":{"searchconds":[{"condtype":"GROUP","condop":"AND","bnotmode":false,"searchconds":[{"condtype":"DEFIELD","fieldname":"resource_type","condop":"EQ","value":"user"}]}]}}',
            itemType: 'GROUP',
            id: 'user',
          },
          {
            addSeparator: true,
            caption: '物料',
            data: '{"theme_model":{"searchconds":[{"condtype":"GROUP","condop":"AND","bnotmode":false,"searchconds":[{"condtype":"DEFIELD","fieldname":"resource_type","condop":"EQ","value":"material"}]}]}}',
            itemType: 'GROUP',
            id: 'material',
          },
          {
        ...
        modelId: '6d7bdf198f739973f5df5bc7a4deb389',
        modelType: 'PSSYSSEARCHBAR',
        name: 'searchbar',
        id: 'ibizodooapp.resource_resource.search_bar',
      },
      {
        detoolbarItems: [
          {
        ...
        controlType: 'TOOLBAR',
        logicName: '资源实体管理视图_工具栏',
        appDataEntityId: 'ibizodooapp.resource_resource',
        controlParam: {
          id: 'toolbar',
        },
        modelId: '3fff810c7e82e816a8a669a7777812f8',
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '004fc04a9dc127b1811df9a34f8807bd',
  modelType: 'PSAPPDEVIEW',
  name: 'resource_resourcemulti_data_view',
  id: 'ibizodooapp.resource_resource_multi_data_view',
};
