export default {
  ...
  deviewId: '8998c94df306da7f76f58ed189a956e7',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.IR_MODEL',
  },
  caption: '模型',
  codeName: 'ir_model_multi_data_view',
    ...
    appViewLogics: [
      {
        ...
        builtinAppUILogic: {
          ...
          newDataAppView: {
            refAppViewId: 'ibizodooapp.ir_model_edit_view',
          },
          appUILogicRefViews: [
            {
              refAppViewId: 'ibizodooapp.ir_model_edit_view',
    ...
    controls: [
      {
        ...
        searchBarGroups: [
          {
            caption: '邮件线程',
            data: '{"theme_model":{"searchconds":[{"condtype":"GROUP","condop":"AND","bnotmode":false,"searchconds":[{"condtype":"DEFIELD","fieldname":"is_mail_thread","condop":"EQ","value":"1"}]}]}}',
            itemType: 'GROUP',
            userParam: {
          ...
          {
            caption: '邮件活动',
            data: '{"theme_model":{"searchconds":[{"condtype":"GROUP","condop":"AND","bnotmode":false,"searchconds":[{"condtype":"DEFIELD","fieldname":"is_mail_activity","condop":"EQ","value":"1"}]}]}}',
            itemType: 'GROUP',
            userParam: {
              filterorgroup: 'group1',
            },
          ...
          {
            caption: '邮件黑名单',
            data: '{"theme_model":{"searchconds":[{"condtype":"GROUP","condop":"AND","bnotmode":false,"searchconds":[{"condtype":"DEFIELD","fieldname":"is_mail_blacklist","condop":"EQ","value":"1"}]}]}}',
            itemType: 'GROUP',
            userParam: {
              filterorgroup: 'group1',
            },
          ...
          },
          {
            addSeparator: true,
            caption: '短暂的',
            data: '{"theme_model":{"searchconds":[{"condtype":"GROUP","condop":"AND","bnotmode":false,"searchconds":[{"condtype":"DEFIELD","fieldname":"transient","condop":"EQ","value":"1"}]}]}}',
            itemType: 'GROUP',
            userParam: {
              filterorgroup: 'group1',
            },
          ...
          {
            caption: '自定义',
            data: '{"theme_model":{"searchconds":[{"condtype":"GROUP","condop":"AND","bnotmode":false,"searchconds":[{"condtype":"DEFIELD","fieldname":"state","condop":"EQ","value":"manual"}]}]}}',
            itemType: 'GROUP',
            userParam: {
          ...
          {
            caption: '基础',
            data: '{"theme_model":{"searchconds":[{"condtype":"GROUP","condop":"AND","bnotmode":false,"searchconds":[{"condtype":"DEFIELD","fieldname":"state","condop":"EQ","value":"base"}]}]}}',
            itemType: 'GROUP',
            userParam: {
              filterorgroup: 'group2',
            },
        ...
        modelId: '11d1b4a568894bcb38e1861f1df9bdd8',
        modelType: 'PSSYSSEARCHBAR',
        name: 'searchbar',
        id: 'ibizodooapp.ir_model.search_bar',
      },
      {
        codeName: 'multi_data_view_toolbar',
        controlType: 'TOOLBAR',
        logicName: '模型实体管理视图_工具栏',
        appDataEntityId: 'ibizodooapp.ir_model',
        controlParam: {
          id: 'toolbar',
        },
        modelId: 'c4e405ece19798cb94eb5ba4bb614d0d',
      ...
      },
      {
        ...
        degridColumns: [
          ...
          },
          {
            ...
            dataItemName: 'state',
            excelCaption: '类型',
            appCodeListId: 'ibizodooapp.base__ir_model_state',
            appDEFieldId: 'state',
            valueType: 'SIMPLE',
            aggMode: 'NONE',
            align: 'LEFT',
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '77b121d0a92f84f3d12a474c0dda9122',
  modelType: 'PSAPPDEVIEW',
  name: 'ir_modelmulti_data_view',
  id: 'ibizodooapp.ir_model_multi_data_view',
};
