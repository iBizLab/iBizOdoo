export default {
  ...
  deviewId: '64e5666b6f59e1aad1ef0fec81082522',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.IR_MODEL_ACCESS',
  },
  caption: '模型访问',
  codeName: 'ir_model_access_edit_view',
  ...
  controls: [
    ...
    },
    {
      ...
      deformPages: [
        {
          ...
          deformDetails: [
            {
              ...
              capLanguageRes: {
                lanResTag:
                  'CONTROL.DEFORM.IR_MODEL_ACCESS.MAIN.GROUPPANEL.GROUP1',
              },
              caption: '模型访问基本信息',
              codeName: 'group1',
              detailStyle: 'DEFAULT',
          ...
          capLanguageRes: {
            lanResTag: 'CONTROL.DEFORM.IR_MODEL_ACCESS.MAIN.FORMPAGE.FORMPAGE1',
          },
          caption: '基本信息',
          codeName: 'formpage1',
          detailStyle: 'DEFAULT',
      ...
      modelId: 'eb49b5d0c78a6b795ff32067c5529ca8',
      modelType: 'PSDEFORM_EDITFORM',
      name: 'form',
      id: 'ibizodooapp.ir_model_access.main',
    },
    {
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '9b6604e05fce1e49a46592920ace8840',
  modelType: 'PSAPPDEVIEW',
  name: 'ir_model_accessEditView',
  id: 'ibizodooapp.ir_model_access_edit_view',
};
