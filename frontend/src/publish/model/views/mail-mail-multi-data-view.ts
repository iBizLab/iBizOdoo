export default {
  ...
  deviewId: '8c6cc1352eda2f6b10bf943407160e60',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.MAIL_MAIL',
  },
  caption: 'EMail',
  codeName: 'mail_mail_multi_data_view',
    ...
    appViewLogics: [
      {
        ...
        builtinAppUILogic: {
          ...
          newDataAppView: {
            refAppViewId: 'ibizodooapp.mail_mail_main_view',
          },
          appUILogicRefViews: [
            {
              refAppViewId: 'ibizodooapp.mail_mail_main_view',
    ...
    controls: [
      {
        ...
        searchBarGroups: [
          {
            caption: '已收',
            data: '{"theme_model":{"searchconds":[{"condtype":"GROUP","condop":"AND","bnotmode":false,"searchconds":[{"condtype":"DEFIELD","fieldname":"state","condop":"EQ","value":"received"}]}]}}',
            itemType: 'GROUP',
            userParam: {
          ...
          {
            caption: '发信',
            data: '{"theme_model":{"searchconds":[{"condtype":"GROUP","condop":"AND","bnotmode":false,"searchconds":[{"condtype":"DEFIELD","fieldname":"state","condop":"EQ","value":"outgoing"}]}]}}',
            itemType: 'GROUP',
            userParam: {
              filterorgroup: 'group1',
            },
          ...
          {
            caption: '已发送',
            data: '{"theme_model":{"searchconds":[{"condtype":"GROUP","condop":"AND","bnotmode":false,"searchconds":[{"condtype":"DEFIELD","fieldname":"state","condop":"EQ","value":"sent"}]}]}}',
            itemType: 'GROUP',
            userParam: {
              filterorgroup: 'group1',
            },
          ...
          },
          {
            addSeparator: true,
            caption: '失败的',
            data: '{"theme_model":{"searchconds":[{"condtype":"GROUP","condop":"AND","bnotmode":false,"searchconds":[{"condtype":"DEFIELD","fieldname":"state","condop":"EQ","value":"exception"}]}]}}',
            itemType: 'GROUP',
            userParam: {
              filterorgroup: 'group1',
            },
        ...
        modelId: '39092eaeab2ba456734d786745a4d971',
        modelType: 'PSSYSSEARCHBAR',
        name: 'searchbar',
        id: 'ibizodooapp.mail_mail.search_bar',
      },
      {
        detoolbarItems: [
          {
        ...
        controlType: 'TOOLBAR',
        logicName: '发送邮件实体管理视图_工具栏',
        appDataEntityId: 'ibizodooapp.mail_mail',
        controlParam: {
          id: 'toolbar',
        },
        modelId: '10947682dfbb3c41ce131d5696f15903',
      ...
      },
      {
        ...
        degridColumns: [
          {
            clconvertMode: 'NONE',
            dataItemName: 'scheduled_date',
            excelCaption: '安排的发送日期',
          ...
          },
          {
            ...
            dataItemName: 'state',
            excelCaption: '状态',
            appCodeListId: 'ibizodooapp.mail__mail_mail_state',
            appDEFieldId: 'state',
            valueType: 'SIMPLE',
            aggMode: 'NONE',
            align: 'LEFT',
            capLanguageRes: {
              lanResTag: 'DEF.LNAME.MAIL_MAIL.STATE',
            },
            caption: '状态',
            codeName: 'state',
            columnType: 'DEFGRIDCOLUMN',
        ...
        modelId: 'e35f798f4431f4386c072eaf24bbb6f9',
        modelType: 'PSDEGRID',
        name: 'grid',
        id: 'ibizodooapp.mail_mail.main',
      },
      {
        capLanguageRes: {
          lanResTag: 'DE.LNAME.MAIL_MAIL',
  ...
  title: '发送邮件',
  titleLanguageRes: {
    lanResTag: 'PAGE.TITLE.MAIL_MAIL.MULTI_DATA_VIEW',
  },
  viewStyle: 'DEFAULT',
  viewType: 'DEMDCUSTOMVIEW',
  enableDP: true,
  showCaptionBar: true,
  modelId: 'dc73cab24fae3812644ffddda35cbcd3',
  modelType: 'PSAPPDEVIEW',
  name: 'mail_mailmulti_data_view',
  id: 'ibizodooapp.mail_mail_multi_data_view',
};
