export default {
  ...
  loadDefault: true,
  deviewCodeName: 'discuss_history_list_view',
  deviewId: 'f0de0231b907defe904d106c251fac04',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'PAGE.CAPTION.MAIL_MESSAGE.DISCUSS_HISTORY_LIST_VIEW',
  },
  caption: '历史消息',
  ...
  controls: [
    ...
    },
    {
      ...
      codeName: 'discuss_history_list_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'ibizodooapp.mail_message',
      controlParam: {},
      name: 'captionbar',
      id: 'discuss_history_list_view_captionbar',
    },
  ],
  sysImage: {
    cssClass: 'fa fa-history',
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '1fa0461f97c79acf617d933f63341a07',
  modelType: 'PSAPPDEVIEW',
  name: 'mail_messagediscuss_history_list_view',
