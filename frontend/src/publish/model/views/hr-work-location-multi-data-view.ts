export default {
  ...
  deviewId: 'b133ebfeba0e0b14dadb557383fbb584',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.HR_WORK_LOCATION',
  },
  caption: '工作地点',
  codeName: 'hr_work_location_multi_data_view',
    ...
    appViewLogics: [
      {
        ...
        builtinAppUILogic: {
          ...
          newDataAppView: {
            refAppViewId: 'ibizodooapp.hr_work_location_main_view',
          },
          appUILogicRefViews: [
            {
              refAppViewId: 'ibizodooapp.hr_work_location_main_view',
    ...
    controls: [
      {
        ...
        modelId: '0beb8df00f731d49bef2a003d947cc39',
        modelType: 'PSSYSSEARCHBAR',
        name: 'searchbar',
        id: 'ibizodooapp.hr_work_location.search_bar',
      },
      {
        detoolbarItems: [
          {
        ...
        controlType: 'TOOLBAR',
        logicName: '工作地点实体管理视图_工具栏',
        appDataEntityId: 'ibizodooapp.hr_work_location',
        controlParam: {
          id: 'toolbar',
        },
        modelId: '59bc979ae0e58eb0bede9ce2edbbcf9e',
      ...
      },
      {
        ...
        degridColumns: [
          ...
          },
          {
            ...
            excelCaption: '封面图片',
            appCodeListId: 'ibizodooapp.hr__hr_work_location_location_type',
        ...
        modelType: 'PSDEGRID',
        name: 'grid',
        id: 'ibizodooapp.hr_work_location.main',
      },
      {
        capLanguageRes: {
          lanResTag: 'DE.LNAME.HR_WORK_LOCATION',
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '99a12fb7cc2cfc4974a176990e2d3aab',
  modelType: 'PSAPPDEVIEW',
  name: 'hr_work_locationmulti_data_view',
  id: 'ibizodooapp.hr_work_location_multi_data_view',
};
