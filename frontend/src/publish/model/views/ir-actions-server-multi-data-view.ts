export default {
  ...
  deviewId: '2c49dc1dfdc328d24d0866e9e962d61e',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.IR_ACTIONS_SERVER',
  },
  caption: '服务器操作',
  codeName: 'ir_actions_server_multi_data_view',
  ...
  viewLayoutPanel: {
    ...
    appViewLogics: [
      {
        ...
        builtinAppUILogic: {
          ...
          newDataAppView: {
            refAppViewId: 'ibizodooapp.ir_actions_server_main_view',
          },
          appUILogicRefViews: [
            {
              refAppViewId: 'ibizodooapp.ir_actions_server_main_view',
    ...
    controls: [
      ...
      },
      {
        ...
        degridColumns: [
          ...
          },
          {
            ...
            dataItemName: 'state',
            excelCaption: '类型',
            appCodeListId: 'ibizodooapp.base__ir_actions_server_state',
            appDEFieldId: 'state',
            valueType: 'SIMPLE',
            aggMode: 'NONE',
            align: 'LEFT',
          ...
          },
          {
            ...
            dataItemName: 'usage',
            excelCaption: '用途',
            appCodeListId: 'ibizodooapp.base__ir_actions_server_usage',
            appDEFieldId: 'usage',
            valueType: 'SIMPLE',
            aggMode: 'NONE',
            align: 'LEFT',
      ...
      },
      {
        ...
        modelId: '60e8dbbdc8c60cf2764672aac8cd8b2d',
        modelType: 'PSSYSSEARCHBAR',
        name: 'searchbar',
        id: 'ibizodooapp.ir_actions_server.search_bar',
      },
      {
        capLanguageRes: {
          lanResTag: 'DE.LNAME.IR_ACTIONS_SERVER',
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '2fc8c3aff91392e139f0558dd2af984e',
  modelType: 'PSAPPDEVIEW',
  name: 'ir_actions_servermulti_data_view',
  id: 'ibizodooapp.ir_actions_server_multi_data_view',
};
