export default {
  ...
  deviewId: '3b695b472ca8ce0a0e14f44bf5b5dd94',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.HR_CONTRACT_TYPE',
  },
  caption: '合同类型',
  codeName: 'hr_contract_type_edit_view',
  ...
  controls: [
    ...
    },
    {
      ...
      deformPages: [
        {
          ...
          deformDetails: [
            {
              ...
              capLanguageRes: {
                lanResTag:
                  'CONTROL.DEFORM.HR_CONTRACT_TYPE.MAIN.GROUPPANEL.GROUP1',
              },
              caption: '合同类型基本信息',
              codeName: 'group1',
              detailStyle: 'DEFAULT',
            ...
            },
            {
              ...
              hidden: true,
              capLanguageRes: {
                lanResTag: 'DEF.LNAME.HR_CONTRACT_TYPE.ID',
              },
              caption: '标识',
              codeName: 'id',
              detailStyle: 'DEFAULT',
          ...
          capLanguageRes: {
            lanResTag:
              'CONTROL.DEFORM.HR_CONTRACT_TYPE.MAIN.FORMPAGE.FORMPAGE1',
          },
          caption: '基本信息',
          codeName: 'formpage1',
          detailStyle: 'DEFAULT',
        ...
        },
        {
          ...
          deformDetails: [
            {
              ...
              capLanguageRes: {
                lanResTag:
                  'CONTROL.DEFORM.HR_CONTRACT_TYPE.MAIN.GROUPPANEL.GROUP2',
              },
              caption: '操作信息',
              codeName: 'group2',
              detailStyle: 'DEFAULT',
          ...
          capLanguageRes: {
            lanResTag:
              'CONTROL.DEFORM.HR_CONTRACT_TYPE.MAIN.FORMPAGE.FORMPAGE2',
          },
          caption: '其它',
          codeName: 'formpage2',
          detailStyle: 'DEFAULT',
      ...
      modelId: 'a51effd015cbeb1bd939a89e08556749',
      modelType: 'PSDEFORM_EDITFORM',
      name: 'form',
      id: 'ibizodooapp.hr_contract_type.main',
    },
    {
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '29742105a85456f5e8ca378043fd8817',
  modelType: 'PSAPPDEVIEW',
  name: 'hr_contract_typeEditView',
  id: 'ibizodooapp.hr_contract_type_edit_view',
};
