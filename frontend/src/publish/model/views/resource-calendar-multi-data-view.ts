export default {
  ...
  deviewId: 'd68625ed2b2ecc011fad51112fed6b7d',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.RESOURCE_CALENDAR',
  },
  caption: '工作时间表',
  codeName: 'resource_calendar_multi_data_view',
    ...
    appViewLogics: [
      {
        ...
        builtinAppUILogic: {
          ...
          newDataAppView: {
            refAppViewId: 'ibizodooapp.resource_calendar_main_view',
          },
          appUILogicRefViews: [
            {
              refAppViewId: 'ibizodooapp.resource_calendar_main_view',
    ...
    controls: [
      {
        ...
        modelType: 'PSDEGRID',
        name: 'grid',
        id: 'ibizodooapp.resource_calendar.main',
      },
      {
        groupMode: 'SINGLE',
        searchBarGroups: [
        ...
        modelId: 'dd6ddacd0f33c674c5f95e5340db8102',
        modelType: 'PSSYSSEARCHBAR',
        name: 'searchbar',
        id: 'ibizodooapp.resource_calendar.search_bar',
      },
      {
        detoolbarItems: [
          {
        ...
        controlType: 'TOOLBAR',
        logicName: '资源工作时间实体管理视图_工具栏',
        appDataEntityId: 'ibizodooapp.resource_calendar',
        controlParam: {
          id: 'toolbar',
        },
        modelId: '9cf0d7221fe2339f3f713cd1ceb5db86',
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '1e4187cff23939a0d3cbfe83d2a94671',
  modelType: 'PSAPPDEVIEW',
  name: 'resource_calendarmulti_data_view',
  id: 'ibizodooapp.resource_calendar_multi_data_view',
};
