export default {
  ...
  deviewId: '1ab165c3fe93de7b0b88a8b631c27af7',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.IR_DEFAULT',
  },
  caption: '默认值',
  codeName: 'ir_default_multi_data_view',
    ...
    appViewLogics: [
      {
        ...
        builtinAppUILogic: {
          ...
          newDataAppView: {
            refAppViewId: 'ibizodooapp.ir_default_main_view',
          },
          appUILogicRefViews: [
            {
              refAppViewId: 'ibizodooapp.ir_default_main_view',
    ...
    controls: [
      {
        ...
        modelId: '19c6b3357e8b9adcf6ca84105cedfab9',
        modelType: 'PSSYSSEARCHBAR',
        name: 'searchbar',
        id: 'ibizodooapp.ir_default.search_bar',
      },
      {
        detoolbarItems: [
          {
        ...
        controlType: 'TOOLBAR',
        logicName: '默认值实体管理视图_工具栏',
        appDataEntityId: 'ibizodooapp.ir_default',
        controlParam: {
          id: 'toolbar',
        },
        modelId: '03f76ac2f70653e7e78e3d55cee13adb',
      ...
      },
      {
        ...
        degridColumns: [
          ...
          {
            clconvertMode: 'NONE',
            dataItemName: 'json_value',
            excelCaption: '默认值 (JSON格式)',
        ...
        modelId: 'a9244d69821a9c4bec5329dbc89e5bd6',
        modelType: 'PSDEGRID',
        name: 'grid',
        id: 'ibizodooapp.ir_default.main',
      },
      {
        capLanguageRes: {
          lanResTag: 'DE.LNAME.IR_DEFAULT',
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '653277ddd46804ae650b55964e4fd425',
  modelType: 'PSAPPDEVIEW',
  name: 'ir_defaultmulti_data_view',
  id: 'ibizodooapp.ir_default_multi_data_view',
};
