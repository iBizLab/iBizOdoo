export default {
  ...
  deviewId: 'f85c0ae0f64b941f7c91fa1e45f8ced7',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'PAGE.CAPTION.HR_JOB.MULTI_DATA_VIEW',
  },
  caption: '工作岗位',
  codeName: 'hr_job_multi_data_view',
  ...
  viewLayoutPanel: {
    ...
    appViewLogics: [
      {
        ...
        builtinAppUILogic: {
          ...
          newDataAppView: {
            refAppViewId: 'ibizodooapp.hr_job_main_view',
          },
          appUILogicRefViews: [
            {
              refAppViewId: 'ibizodooapp.hr_job_main_view',
    ...
    controls: [
      ...
      },
      {
        ...
        modelId: '9b57a41b5217be0500c3be0e10e26981',
        modelType: 'PSSYSSEARCHBAR',
        name: 'searchbar',
        id: 'ibizodooapp.hr_job.search_bar',
      },
      {
        detoolbarItems: [
          {
        ...
        controlType: 'TOOLBAR',
        logicName: '工作岗位实体管理视图_工具栏',
        appDataEntityId: 'ibizodooapp.hr_job',
        controlParam: {
          id: 'toolbar',
        },
        modelId: '15acfb5a6d1b1ac51d91cdd2f9086d69',
  ...
  title: '工作岗位',
  titleLanguageRes: {
    lanResTag: 'PAGE.TITLE.HR_JOB.MULTI_DATA_VIEW',
  },
  viewStyle: 'DEFAULT',
  viewType: 'DEMDCUSTOMVIEW',
  enableDP: true,
  showCaptionBar: true,
  modelId: 'de7ae814a1e19f3d7605a0fcbd2849a5',
  modelType: 'PSAPPDEVIEW',
  name: 'hr_jobmulti_data_view',
  id: 'ibizodooapp.hr_job_multi_data_view',
};
