export default {
  ...
  deviewId: '2eea8594460e96db84c9f7b84598baa2',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.IR_MAIL_SERVER',
  },
  caption: '发送服务器',
  codeName: 'ir_mail_server_main_view',
  appDataEntityId: 'ibizodooapp.ir_mail_server',
  viewLayoutPanel: {
    viewProxyMode: true,
    layoutMode: 'FLEX',
    layout: {
    ...
    controls: [
      ...
      },
      {
        ...
        deformPages: [
          {
            ...
            deformDetails: [
              {
                ...
                deformDetails: [
                  {
                    ...
                    deformDetails: [
                      ...
                      },
                      {
                        ...
                        editor: {
                          appCodeListId:
                            'ibizodooapp.base__ir_mail_server_smtp_authentication',
                        ...
                        capLanguageRes: {
                          lanResTag:
                            'DEF.LNAME.IR_MAIL_SERVER.SMTP_AUTHENTICATION',
                        },
                        caption: '验证',
                  ...
                  },
                  {
                    ...
                    deformDetails: [
                      ...
                      {
                        rawItem: {
                          content: '<p style="text-align: left;">MB</p>',
                          contentType: 'HTML',
                          id: 'rawitem3',
                        },
                        codeName: 'rawitem3',
                            ...
                            deformDetails: [
                              {
                                ...
                                editor: {
                                  appCodeListId:
                                    'ibizodooapp.base__ir_mail_server_smtp_encryption',
                                  editorType: 'RADIOBUTTONLIST',
                                  valueType: 'SIMPLE',
                                  editable: true,
                                  id: 'smtp_encryption',
                                ...
                                capLanguageRes: {
                                  lanResTag:
                                    'DEF.LNAME.IR_MAIL_SERVER.SMTP_ENCRYPTION',
                                },
                                caption: '连接加密',
                              ...
                              },
                              {
                                ...
                                capLanguageRes: {
                                  lanResTag:
                                    'DEF.LNAME.IR_MAIL_SERVER.SMTP_DEBUG',
                                },
                                caption: '调试',
                                codeName: 'smtp_debug',
                                detailStyle: 'DEFAULT',
                              ...
                              },
                              {
                                ...
                                capLanguageRes: {
                                  lanResTag:
                                    'DEF.LNAME.IR_MAIL_SERVER.SMTP_HOST',
                                },
                                caption: 'SMTP服务器',
                                codeName: 'smtp_host',
                                detailStyle: 'DEFAULT',
                              ...
                              },
                              {
                                ...
                                capLanguageRes: {
                                  lanResTag:
                                    'DEF.LNAME.IR_MAIL_SERVER.SMTP_PORT',
                                },
                                caption: 'SMTP端口',
                                codeName: 'smtp_port',
                                detailStyle: 'DEFAULT',
                            ...
                            deformDetails: [
                              {
                                ...
                                capLanguageRes: {
                                  lanResTag:
                                    'DEF.LNAME.IR_MAIL_SERVER.SMTP_USER',
                                },
                                caption: '用户名',
                                codeName: 'smtp_user',
                                detailStyle: 'DEFAULT',
                              ...
                              },
                              {
                                ...
                                capLanguageRes: {
                                  lanResTag:
                                    'DEF.LNAME.IR_MAIL_SERVER.SMTP_PASS',
                                },
                                caption: '密码',
                                codeName: 'smtp_pass',
                                detailStyle: 'DEFAULT',
                ...
                capLanguageRes: {
                  lanResTag:
                    'CONTROL.DEFORM.IR_MAIL_SERVER.MAIN.GROUPPANEL.GROUP1',
                },
                caption: '邮件服务器基本信息',
                codeName: 'group1',
                detailStyle: 'DEFAULT',
            ...
            capLanguageRes: {
              lanResTag:
                'CONTROL.DEFORM.IR_MAIL_SERVER.MAIN.FORMPAGE.FORMPAGE1',
            },
            caption: '基本信息',
            codeName: 'formpage1',
            detailStyle: 'DEFAULT',
        ...
        modelId: '4c8437a301467f68c18468fb0134dfdf',
        modelType: 'PSDEFORM_EDITFORM',
        name: 'form',
        id: 'ibizodooapp.ir_mail_server.main',
      },
      {
        detoolbarItems: [
          {
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '883aeb74d89d9aac603162ab4b858185',
  modelType: 'PSAPPDEVIEW',
  name: 'ir_mail_servermain_view',
  id: 'ibizodooapp.ir_mail_server_main_view',
};
