export default {
  deviewCodeName: 'main_pop_view',
  deviewId: '56768c56f2af36c748fb09cf490a7ce2',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.DISCUSS_CHANNEL',
  },
  caption: '讨论频道',
  codeName: 'discuss_channel_main_pop_view',
  ...
  viewLayoutPanel: {
    ...
    controls: [
      ...
      },
      {
        ...
        codeName: 'main_pop_view_pinned_message_view',
        controlType: 'VIEWPANEL',
        appDataEntityId: 'ibizodooapp.discuss_channel',
        controlParam: {},
        name: 'pinned_message_view',
        id: 'main_pop_view_pinned_message_view',
      },
      {
        embeddedAppDEViewId: 'ibizodooapp.mail_message_search_list_view',
        codeName: 'main_pop_view_search_message_view',
        controlType: 'VIEWPANEL',
        appDataEntityId: 'ibizodooapp.discuss_channel',
        controlParam: {},
        name: 'search_message_view',
        id: 'main_pop_view_search_message_view',
      },
      {
        capLanguageRes: {
          lanResTag: 'DE.LNAME.DISCUSS_CHANNEL',
        ...
        caption: '讨论频道',
        codeName: 'main_pop_view_captionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'ibizodooapp.discuss_channel',
        controlParam: {},
        name: 'captionbar',
        id: 'main_pop_view_captionbar',
      },
    ],
  ...
  modelId: '416f64ebe3a6da4752e7f7de583ac61b',
  modelType: 'PSAPPDEVIEW',
  name: 'discuss_channelmain_pop_view',
  id: 'ibizodooapp.discuss_channel_main_pop_view',
};
