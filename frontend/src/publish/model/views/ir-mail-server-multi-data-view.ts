export default {
  ...
  deviewId: '6a7c1e8cd4d4f7d4ffcce58d1f327acf',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.IR_MAIL_SERVER',
  },
  caption: '发送服务器',
  codeName: 'ir_mail_server_multi_data_view',
    ...
    appViewLogics: [
      {
        ...
        builtinAppUILogic: {
          ...
          newDataAppView: {
            refAppViewId: 'ibizodooapp.ir_mail_server_main_view',
          },
          appUILogicRefViews: [
            {
              refAppViewId: 'ibizodooapp.ir_mail_server_main_view',
    ...
    controls: [
      ...
      },
      {
        ...
        degridColumns: [
          ...
          {
            clconvertMode: 'NONE',
            dataItemName: 'smtp_host',
            excelCaption: 'SMTP服务器',
          ...
          {
            clconvertMode: 'FRONT',
            dataItemName: 'smtp_encryption',
            excelCaption: '连接加密',
            appCodeListId: 'ibizodooapp.base__ir_mail_server_smtp_encryption',
          ...
          {
            clconvertMode: 'NONE',
            dataItemName: 'from_filter',
            excelCaption: 'FROM 过滤',
      ...
      },
      {
        ...
        modelId: 'ccd8567f129a61fb4160859da39cd98c',
        modelType: 'PSSYSSEARCHBAR',
        name: 'searchbar',
        id: 'ibizodooapp.ir_mail_server.search_bar',
      },
      {
        capLanguageRes: {
          lanResTag: 'DE.LNAME.IR_MAIL_SERVER',
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '0ccd0c8c02bed7d2c1b7e279a259982c',
  modelType: 'PSAPPDEVIEW',
  name: 'ir_mail_servermulti_data_view',
  id: 'ibizodooapp.ir_mail_server_multi_data_view',
};
