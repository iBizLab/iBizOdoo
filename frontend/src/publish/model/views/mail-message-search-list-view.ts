export default {
  ...
  deviewCodeName: 'search_list_view',
  deviewId: 'e1fa77f06681ac0483708c670fd85fca',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'PAGE.CAPTION.MAIL_MESSAGE.SEARCH_LIST_VIEW',
  },
  caption: '消息检索',
  ...
  controls: [
    ...
    },
    {
      ...
      caption: '消息检索',
      codeName: 'search_list_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'ibizodooapp.mail_message',
      controlParam: {},
      name: 'captionbar',
      id: 'search_list_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  title: '消息检索',
  titleLanguageRes: {
    lanResTag: 'PAGE.TITLE.MAIL_MESSAGE.SEARCH_LIST_VIEW',
  },
  viewStyle: 'DEFAULT',
  viewType: 'DELISTVIEW',
  enableDP: true,
  showCaptionBar: false,
  modelId: 'a6165f6fc236ad0fad85be6433e4ced3',
  modelType: 'PSAPPDEVIEW',
  name: 'mail_messagesearch_list_view',
