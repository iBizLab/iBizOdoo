export default {
  ...
  deviewId: 'b05608293526565c04b33a99e7e2ee7a',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.HR_CONTRACT_TYPE',
  },
  caption: '就业类型',
  codeName: 'hr_contract_type_multi_data_view',
  appDataEntityId: 'ibizodooapp.hr_contract_type',
  viewLayoutPanel: {
    viewProxyMode: true,
    layoutMode: 'FLEX',
    layout: {
    ...
    appViewLogics: [
      {
        ...
        builtinAppUILogic: {
          ...
          newDataAppView: {
            refAppViewId: 'ibizodooapp.hr_contract_type_edit_view',
          },
          appUILogicRefViews: [
            {
              refAppViewId: 'ibizodooapp.hr_contract_type_edit_view',
    ...
    controls: [
      {
        ...
        degridColumns: [
          {
            ...
            align: 'LEFT',
            capLanguageRes: {
              lanResTag: 'DEF.LNAME.HR_CONTRACT_TYPE.NAME',
            },
            caption: '名称',
            codeName: 'name',
          ...
          },
          {
            ...
            align: 'LEFT',
            capLanguageRes: {
              lanResTag: 'DEF.LNAME.HR_CONTRACT_TYPE.CODE',
            },
            caption: '代码',
            codeName: 'code',
            columnType: 'DEFGRIDCOLUMN',
          ...
          {
            clconvertMode: 'FRONT',
            dataItemName: 'country_id',
            excelCaption: '国家/地区',
            appCodeListId: 'ibizodooapp.base__res_country',
            ...
            align: 'LEFT',
            capLanguageRes: {
              lanResTag: 'DEF.LNAME.HR_CONTRACT_TYPE.COUNTRY_ID',
            },
            caption: '国家/地区',
        ...
        degridEditItems: [
          ...
          },
          {
            ...
            editor: {
              ...
              singleSelect: true,
              pickupAppViewId: 'ibizodooapp.res_country_pickup_view',
        ...
        modelId: '25eea34f03d668ca625d414990d514de',
        modelType: 'PSDEGRID',
        name: 'grid',
        id: 'ibizodooapp.hr_contract_type.edit_main',
      },
      {
        groupMode: 'AND',
        quickGroupCount: 1,
        ...
        modelId: '1e379028f25cd29e8cb42e2c0b8255f6',
        modelType: 'PSSYSSEARCHBAR',
        name: 'searchbar',
        id: 'ibizodooapp.hr_contract_type.search_bar',
      },
      {
        ...
        logicName: '合同类型实体管理视图_搜索表单',
        appDataEntityId: 'ibizodooapp.hr_contract_type',
        controlParam: {
          id: 'searchform',
        },
        modelId: '3439b00fbd45d5641a4bd76d71b2fbd1',
        modelType: 'PSDEFORM_SEARCHFORM',
        name: 'searchform',
        id: 'ibizodooapp.hr_contract_type.main2',
      },
      {
        detoolbarItems: [
          {
        ...
        controlType: 'TOOLBAR',
        logicName: '合同类型实体管理视图_工具栏',
        appDataEntityId: 'ibizodooapp.hr_contract_type',
        controlParam: {
          id: 'toolbar',
        },
        modelId: '9e46ee3a5d9d3b4755227f30bb0995fc',
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '9e1ee3b8c78f408d4290f8abf6debac9',
  modelType: 'PSAPPDEVIEW',
  name: 'hr_contract_typemulti_data_view',
  id: 'ibizodooapp.hr_contract_type_multi_data_view',
};
