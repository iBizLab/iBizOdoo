export default {
  ...
  deviewId: '0679a5cc47a76e3c79a6f429de6c7bfb',
  accUserMode: 2,
  capLanguageRes: {
  ...
  viewLayoutPanel: {
    ...
    appViewLogics: [
      {
        ...
        builtinAppUILogic: {
          ...
          newDataAppView: {
            refAppViewId: 'ibizodooapp.mail_activity_plan_main_view',
          },
          appUILogicRefViews: [
            {
              refAppViewId: 'ibizodooapp.mail_activity_plan_main_view',
    ...
    controls: [
      ...
      },
      {
        ...
        logicName: '活动计划实体管理视图_搜索表单',
        appDataEntityId: 'ibizodooapp.mail_activity_plan',
        controlParam: {
          id: 'searchform',
        },
        modelId: '31e866df5ce8c14ed004cd438ea4b8b6',
        modelType: 'PSDEFORM_SEARCHFORM',
        name: 'searchform',
        id: 'ibizodooapp.mail_activity_plan.main2',
      },
      {
        detoolbarItems: [
          {
      ...
      },
      {
        ...
        modelId: 'cb16795866948c2f3aebf988c2f7bab7',
        modelType: 'PSDEGRID',
        name: 'grid',
        id: 'ibizodooapp.mail_activity_plan.hr_main',
      },
      {
        capLanguageRes: {
          lanResTag: 'DE.LNAME.MAIL_ACTIVITY_PLAN',
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '3ae8e0cb19b0d98e08f08632674f6580',
  modelType: 'PSAPPDEVIEW',
  name: 'mail_activity_planmulti_data_view',
