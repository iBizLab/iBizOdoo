export default {
  ...
  deviewId: '019b59b88af5dbce862522b02b9106e0',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.MAIL_FOLLOWERS',
  },
  caption: '单据关注者',
  codeName: 'mail_followers_multi_data_view',
    ...
    appViewLogics: [
      {
        ...
        builtinAppUILogic: {
          ...
          newDataAppView: {
            refAppViewId: 'ibizodooapp.mail_followers_main_view',
          },
          appUILogicRefViews: [
            {
              refAppViewId: 'ibizodooapp.mail_followers_main_view',
    ...
    controls: [
      {
        ...
        modelId: '0dc387bed2b317d9284efa00c6e7be57',
        modelType: 'PSSYSSEARCHBAR',
        name: 'searchbar',
        id: 'ibizodooapp.mail_followers.search_bar',
      },
      {
        detoolbarItems: [
          {
      ...
      },
      {
        ...
        degridColumns: [
          {
            clconvertMode: 'NONE',
            dataItemName: 'res_model',
            excelCaption: '相关的单据模型名称',
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '6884f4df39fafaf280dbd2181d95972b',
  modelType: 'PSAPPDEVIEW',
  name: 'mail_followersmulti_data_view',
  id: 'ibizodooapp.mail_followers_multi_data_view',
};
