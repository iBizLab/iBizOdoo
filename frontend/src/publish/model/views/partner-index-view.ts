export default {
    ...
    controls: [
      {
        ...
        logicName: '联系人首页视图',
        controlParam: {},
        modelId: 'a943565656251a2186aee47acafe85ec',
        modelType: 'PSAPPMENU',
        name: 'appmenu',
        id: 'partner_index_view',
      },
      {
        caption: '联系人',
        subCaption: '联系人',
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '2b4b6afb029569ef6e74ec1ee577a194',
  modelType: 'PSAPPINDEXVIEW',
  name: 'PartnerIndexView',
  id: 'ibizodooapp.partner_index_view',
};
