export default {
  ...
  deviewId: '11948e8bfea004b7a274f79184bb6c01',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.MAIL_ALIAS_DOMAIN',
  },
  caption: '别名域',
  codeName: 'mail_alias_domain_multi_data_view',
  ...
  viewLayoutPanel: {
    ...
    appViewLogics: [
      {
        ...
        builtinAppUILogic: {
          ...
          newDataAppView: {
            refAppViewId: 'ibizodooapp.mail_alias_domain_main_view',
          },
          appUILogicRefViews: [
            {
              refAppViewId: 'ibizodooapp.mail_alias_domain_main_view',
    ...
    controls: [
      ...
      },
      {
        ...
        modelId: '96a78f7144a742ae4ab242e1a4456c05',
        modelType: 'PSSYSSEARCHBAR',
        name: 'searchbar',
        id: 'ibizodooapp.mail_alias_domain.search_bar',
      },
      {
        capLanguageRes: {
          lanResTag: 'DE.LNAME.MAIL_ALIAS_DOMAIN',
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '4ffbe32ca3be7d17071126302f3a3e25',
  modelType: 'PSAPPDEVIEW',
  name: 'mail_alias_domainmulti_data_view',
  id: 'ibizodooapp.mail_alias_domain_multi_data_view',
};
