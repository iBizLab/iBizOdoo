export default {
  ...
  deviewId: '17354b25444ae34ba4e4da8aa2b29561',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.HR_DEPARTURE_REASON',
  },
  caption: '离职原因',
  codeName: 'hr_departure_reason_multi_data_view',
    ...
    controls: [
      {
        ...
        controlType: 'TOOLBAR',
        logicName: '离职原因实体管理视图_工具栏',
        appDataEntityId: 'ibizodooapp.hr_departure_reason',
        controlParam: {
          id: 'toolbar',
        },
        modelId: 'b49cb8eec522e6e2fb6899bf743eb546',
      ...
      },
      {
        ...
        modelId: '1393b4bec5f82edce5fcc968c6308d57',
        modelType: 'PSDEGRID',
        name: 'grid',
        id: 'ibizodooapp.hr_departure_reason.edit_main',
      },
      {
        groupMode: 'AND',
        quickGroupCount: 1,
        ...
        modelId: '88aa760d2a257c7abe68fbde793b3c03',
        modelType: 'PSSYSSEARCHBAR',
        name: 'searchbar',
        id: 'ibizodooapp.hr_departure_reason.search_bar',
      },
      {
        ...
        logicName: '离职原因实体管理视图_搜索表单',
        appDataEntityId: 'ibizodooapp.hr_departure_reason',
        controlParam: {
          id: 'searchform',
        },
        modelId: '8209a4a839d6033cab8f8437648a085d',
        modelType: 'PSDEFORM_SEARCHFORM',
        name: 'searchform',
        id: 'ibizodooapp.hr_departure_reason.main2',
      },
      {
        capLanguageRes: {
          lanResTag: 'DE.LNAME.HR_DEPARTURE_REASON',
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: 'd99501bd0e1c4ddc5c88cc0845ca8382',
  modelType: 'PSAPPDEVIEW',
  name: 'hr_departure_reasonmulti_data_view',
  id: 'ibizodooapp.hr_departure_reason_multi_data_view',
};
