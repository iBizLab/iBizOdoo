export default {
  ...
  deviewId: '289fc227a89ce0bcb50ccf70fb549178',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.IR_CONFIG_PARAMETER',
  },
  caption: '系统参数',
  codeName: 'ir_config_parameter_multi_data_view',
    ...
    appViewLogics: [
      {
        ...
        builtinAppUILogic: {
          ...
          newDataAppView: {
            refAppViewId: 'ibizodooapp.ir_config_parameter_main_view',
          },
          appUILogicRefViews: [
            {
              refAppViewId: 'ibizodooapp.ir_config_parameter_main_view',
    ...
    controls: [
      {
        ...
        modelId: '27329e4cb39d874010460ab00a759663',
        modelType: 'PSSYSSEARCHBAR',
        name: 'searchbar',
        id: 'ibizodooapp.ir_config_parameter.search_bar',
      },
      {
        detoolbarItems: [
          {
        ...
        controlType: 'TOOLBAR',
        logicName: '系统参数实体管理视图_工具栏',
        appDataEntityId: 'ibizodooapp.ir_config_parameter',
        controlParam: {
          id: 'toolbar',
        },
        modelId: 'bec26a1b059234d674a2d5d152bf8c29',
      ...
      },
      {
        ...
        modelId: '64d6cb437245b2fa8f2c00e6fcae043d',
        modelType: 'PSDEGRID',
        name: 'grid',
        id: 'ibizodooapp.ir_config_parameter.main',
      },
      {
        capLanguageRes: {
          lanResTag: 'DE.LNAME.IR_CONFIG_PARAMETER',
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '0357c55e8bd52e54d2f11232ad3c7ef6',
  modelType: 'PSAPPDEVIEW',
  name: 'ir_config_parametermulti_data_view',
  id: 'ibizodooapp.ir_config_parameter_multi_data_view',
};
