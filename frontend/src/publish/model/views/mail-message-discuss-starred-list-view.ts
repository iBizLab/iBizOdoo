export default {
  ...
  loadDefault: true,
  deviewCodeName: 'discuss_starred_list_view',
  deviewId: '858d8b0b5444cb02833790e9dbb1aed8',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'PAGE.CAPTION.MAIL_MESSAGE.DISCUSS_STARRED_LIST_VIEW',
  },
  caption: '星标消息',
  codeName: 'mail_message_discuss_starred_list_view',
  ...
  controls: [
    {
      ...
      fetchControlAction: {
        appDEMethodId: 'fetch_common_all',
        appDataEntityId: 'ibizodooapp.mail_message',
        id: 'fetch',
      },
      getControlAction: {
    ...
    },
    {
      ...
      codeName: 'discuss_starred_list_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'ibizodooapp.mail_message',
      controlParam: {},
      name: 'captionbar',
      id: 'discuss_starred_list_view_captionbar',
    },
  ],
  sysImage: {
    cssClass: 'fa fa-star-o',
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '6443d31fb854bb4b44a30ec3d3bf2a49',
  modelType: 'PSAPPDEVIEW',
  name: 'mail_messagediscuss_starred_list_view',
  id: 'ibizodooapp.mail_message_discuss_starred_list_view',
};
