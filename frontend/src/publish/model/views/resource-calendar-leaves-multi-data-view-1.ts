export default {
  mdctrlActiveMode: 1,
  loadDefault: true,
  deviewCodeName: 'multi_data_view1',
  deviewId: '5492e4ea639fa8cd78b6f16402876f4d',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.RESOURCE_CALENDAR_LEAVES',
  },
  caption: '休息时间',
  codeName: 'resource_calendar_leaves_multi_data_view1',
    ...
    controls: [
      {
        ...
        codeName: 'multi_data_view1_toolbar',
        controlType: 'TOOLBAR',
        logicName: '休假详细信息实体管理视图_休息时间工具栏',
        appDataEntityId: 'ibizodooapp.resource_calendar_leaves',
        controlParam: {
          id: 'toolbar',
        },
        modelId: '7144299c95ad665347ba44c3c161e272',
        modelType: 'PSDETOOLBAR',
        name: 'toolbar',
        id: 'multi_data_view1_toolbar',
      },
      {
        aggMode: 'NONE',
        ...
        modelId: '5a095e562ba94dd38e9a5fb74622f24c',
        modelType: 'PSDEGRID',
        name: 'grid',
        id: 'ibizodooapp.resource_calendar_leaves.main1',
      },
      {
        groupMode: 'AND',
        searchBarGroups: [
      ...
      },
      {
        ...
        caption: '休息时间',
        codeName: 'multi_data_view1_captionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'ibizodooapp.resource_calendar_leaves',
        controlParam: {},
        name: 'captionbar',
        id: 'multi_data_view1_captionbar',
      },
    ],
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '06e1927703f6447d913590d645579f12',
  modelType: 'PSAPPDEVIEW',
  name: 'resource_calendar_leavesmulti_data_view1',
  id: 'ibizodooapp.resource_calendar_leaves_multi_data_view1',
};
