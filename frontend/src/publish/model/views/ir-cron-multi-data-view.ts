export default {
  ...
  deviewId: '92b2c0363aa10aee1fb6063a8c874966',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.IR_CRON',
  },
  caption: '计划的操作',
  codeName: 'ir_cron_multi_data_view',
  ...
  viewLayoutPanel: {
    ...
    appViewLogics: [
      {
        ...
        builtinAppUILogic: {
          ...
          newDataAppView: {
            refAppViewId: 'ibizodooapp.ir_cron_main_view',
          },
          appUILogicRefViews: [
            {
              refAppViewId: 'ibizodooapp.ir_cron_main_view',
    ...
    controls: [
      ...
      },
      {
        ...
        searchBarGroups: [
          {
            ...
            defaultGroup: true,
            caption: '全部',
            data: '{"theme_model":{"searchconds":[{"condtype":"GROUP","condop":"OR","bnotmode":false,"searchconds":[{"condtype":"DEFIELD","fieldname":"active","condop":"EQ","value":"0"},{"condtype":"DEFIELD","fieldname":"active","condop":"EQ","value":"1"}]}]}}',
            itemType: 'GROUP',
            id: 'all',
          },
          {
        ...
        modelId: 'aa96c744aa37582e5053ad22a88cd7a8',
        modelType: 'PSSYSSEARCHBAR',
        name: 'searchbar',
        id: 'ibizodooapp.ir_cron.search_bar',
      },
      {
        aggMode: 'NONE',
  ...
  title: '计划的操作',
  titleLanguageRes: {
    lanResTag: 'PAGE.TITLE.IR_CRON.MULTI_DATA_VIEW',
  },
  viewStyle: 'DEFAULT',
  viewType: 'DEMDCUSTOMVIEW',
  enableDP: true,
  showCaptionBar: true,
  modelId: 'b6a6cfdcf8e6627da7dcc96c19fd7a39',
  modelType: 'PSAPPDEVIEW',
  name: 'ir_cronmulti_data_view',
  id: 'ibizodooapp.ir_cron_multi_data_view',
};
