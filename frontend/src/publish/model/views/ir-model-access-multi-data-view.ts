export default {
  ...
  appDataEntityId: 'ibizodooapp.ir_model_access',
  viewLayoutPanel: {
    viewProxyMode: true,
    layoutMode: 'FLEX',
    layout: {
    ...
    appViewLogics: [
      {
        ...
        builtinAppUILogic: {
          ...
          newDataAppView: {
            refAppViewId: 'ibizodooapp.ir_model_access_edit_view',
          },
          appUILogicRefViews: [
            {
              refAppViewId: 'ibizodooapp.ir_model_access_edit_view',
    ...
    controls: [
      {
        ...
        name: 'searchbar',
        id: 'ibizodooapp.ir_model_access.search_bar',
      },
      {
        aggMode: 'NONE',
        ...
        degridEditItems: [
          ...
          },
          {
            ...
            editor: {
              ...
              pickupAppViewId: 'ibizodooapp.res_groups_pickup_view',
        ...
        modelType: 'PSDEGRID',
        name: 'grid',
        id: 'ibizodooapp.ir_model_access.main2',
      },
      {
        detoolbarItems: [
          {
  ...
  id: 'ibizodooapp.ir_model_access_multi_data_view',
};
