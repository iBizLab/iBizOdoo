export default {
  mdctrlActiveMode: 1,
  loadDefault: true,
  deviewCodeName: 'public_multi_data_view',
  deviewId: '7d5d55ff2cf9907b362cf2c9b860149b',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.DISCUSS_CHANNEL',
  },
  caption: '公共频道',
  codeName: 'discuss_channel_public_multi_data_view',
    ...
    controls: [
      {
        ...
        codeName: 'public_multi_data_view_toolbar',
        controlType: 'TOOLBAR',
        ...
        name: 'toolbar',
        id: 'public_multi_data_view_toolbar',
      },
      {
        cardColLG: 6,
        cardColMD: 8,
        ...
        itemLayoutPanel: {
                  ...
                  panelItems: [
                    {
                      ...
                      uiactionId: 'join_channel@discuss_channel',
                      renderMode: 'BUTTON',
                      tooltip: '加入',
                      ...
                      panelItemGroupLogics: [
                        {
                          ...
                          relatedItemNames: ['is_member'],
                          groupOP: 'AND',
                          panelItemLogics: [
                            {
                              condOp: 'EQ',
                              dstModelField: 'IS_MEMBER',
                              value: '0',
                              logicType: 'SINGLE',
                              name: 'IS_MEMBER 等于(=) 0',
                              id: 'is_member 等于(=) 0',
          ...
          layoutPanel: true,
          codeName: 'discuss_channel_info',
          controlType: 'PANEL',
          logicName: 'discuss_channel卡片视图',
          appDataEntityId: 'ibizodooapp.discuss_channel',
          controlParam: {},
          modelId: '9680055b78f912e5208a93a187e35ceb',
          modelType: 'PSSYSVIEWPANEL',
          name: 'itemlayoutpanel',
          id: 'ibizodooapp.discuss_channel.discuss_channel_info',
        },
        dedataViewDataItems: [
          {
            appDEFieldId: 'id',
      ...
      },
      {
        ...
        modelId: '01c5a6c115c46696c5bfa541d75c08fe',
        modelType: 'PSSYSSEARCHBAR',
        name: 'searchbar',
        id: 'ibizodooapp.discuss_channel.search_bar',
      },
      {
      ...
      },
      {
        ...
        caption: '公共频道',
        codeName: 'public_multi_data_view_captionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'ibizodooapp.discuss_channel',
        controlParam: {},
        name: 'captionbar',
        id: 'public_multi_data_view_captionbar',
      },
    ],
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '53e2bc2fecbd1712a8c3fddbea201412',
  modelType: 'PSAPPDEVIEW',
  name: 'discuss_channelpublic_multi_data_view',
  id: 'ibizodooapp.discuss_channel_public_multi_data_view',
};
