export default {
  ...
  deviewId: 'bdac7572256cd31a4143a6f070fcce71',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.HR_DEPARTMENT',
  },
  caption: '部门',
  codeName: 'hr_department_multi_data_view',
    ...
    controls: [
      {
        ...
        modelId: 'fe1465672509663ee6331742a8f483a2',
        modelType: 'PSSYSSEARCHBAR',
        name: 'searchbar',
        id: 'ibizodooapp.hr_department.search_bar',
      },
      {
        aggMode: 'NONE',
        ...
        modelType: 'PSDEGRID',
        name: 'grid',
        id: 'ibizodooapp.hr_department.main',
      },
      {
        cardColLG: 6,
        cardColMD: 8,
        ...
        itemLayoutPanel: {
                      ...
                      panelItems: [
                        {
                          editor: {
                            ...
                            valign: 'MIDDLE',
                            wrapMode: 'NOWRAP',
                            appCodeListId: 'ibizodooapp.hr__hr_employee',
                      ...
                      panelItems: [
                        {
                          ...
                          captionItemName: 'TOTAL_EMPLOYEE',
                          uiactionId:
                            'open_employee_multi_data_view@hr_department',
                          renderMode: 'BUTTON',
                          tooltip: '员工',
                          uiactionTarget: 'NONE',
                          caption: '员工',
          ...
          layoutPanel: true,
          codeName: 'ab21d9c0f00ab5cb106',
          controlType: 'PANEL',
          logicName: 'department_info卡片视图',
          appDataEntityId: 'ibizodooapp.hr_department',
          controlParam: {},
          modelId: '2c53c016ee8f3123f5f97131937ca4c9',
          modelType: 'PSSYSVIEWPANEL',
          name: 'itemlayoutpanel',
          id: 'ibizodooapp.hr_department.ab21d9c0f00ab5cb106',
        },
        minorSortDir: 'DESC',
        minorSortAppDEFieldId: 'write_date',
        dedataViewDataItems: [
        ...
        modelId: 'bfdc5304ac3edb71c1f521f7cfbce1d6',
        modelType: 'PSDEDATAVIEW',
        name: 'dataview',
        id: 'ibizodooapp.hr_department.department_info',
      },
      {
        detoolbarItems: [
          {
        ...
        controlType: 'TOOLBAR',
        logicName: '部门实体管理视图_工具栏',
        appDataEntityId: 'ibizodooapp.hr_department',
        controlParam: {
          id: 'toolbar',
        },
        modelId: '0163b09f148437ddc30d3d3406749108',
      ...
      },
      {
        detreeNodeRSs: [
          {
            ...
            parentValueLevel: 1,
            searchMode: 3,
            name: '默认根节点（ROOT）-当前部门（cur）',
            id: '默认根节点（root）-当前部门（cur）',
          },
          {
            ...
            parentValueLevel: 1,
            searchMode: 3,
            id: '下属部门（children）-下属部门（children）',
          },
          {
            childDETreeNodeId: 'children',
            parentAppDEFieldId: 'parent_id',
        ...
        detreeNodes: [
          ...
          },
          {
            ...
            navAppViewId: 'ibizodooapp.hr_department_main_view',
            nodeType: 'children',
            appDataEntityId: 'ibizodooapp.hr_department',
            navigateContexts: [
              {
            ...
            controlRenders: [
              {
                layoutPanel: {
                  ...
                  mobilePanel: true,
                  codeName: 'department_chart_node_panel',
                  controlType: 'PANEL',
                  logicName: '部门架构图节点绘制面板',
                  appDataEntityId: 'ibizodooapp.hr_department',
                  controlLogics: [
                    {
                      eventNames: 'onClick',
                  ...
                  controlParam: {},
                  modelId: '01bd69d20ed87509683333a568ff1f5d',
                  modelType: 'PSSYSVIEWPANEL',
                  name: 'childen_layout',
                  id: 'ibizodooapp.hr_department.department_chart_node_panel',
                },
              ...
              },
              {
                layoutPanel: {
                  ...
                  layoutPanel: true,
                  mobilePanel: true,
                  codeName: 'dept_active_node_panel',
                  controlType: 'PANEL',
                  logicName: '部门架构图激活节点绘制面板',
                  appDataEntityId: 'ibizodooapp.hr_department',
                  controlParam: {},
                  modelId: '0e45014878e79c35483e14834cc61b63',
                  modelType: 'PSSYSVIEWPANEL',
                  name: 'activenoderender_childen',
                  id: 'ibizodooapp.hr_department.dept_active_node_panel',
                },
                renderType: 'LAYOUTPANEL',
          ...
          },
          {
            dataSourceType: 'DEDATASET',
            idAppDEFieldId: 'id',
            appDEDataSetId: 'fetch_department_hierarchy',
            textAppDEFieldId: 'name',
            navAppViewId: 'ibizodooapp.hr_department_main_view',
            nodeType: 'cur',
            appDataEntityId: 'ibizodooapp.hr_department',
        ...
        modelId: '88f79a5e6701213faf79e4a4323245ab',
        modelType: 'PSDETREEVIEW',
        name: 'hierarchy',
        id: 'ibizodooapp.hr_department.department_hierarchy',
      },
      {
        capLanguageRes: {
          lanResTag: 'DE.LNAME.HR_DEPARTMENT',
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: 'b2c14b6cc8547d745f47595db881963c',
  modelType: 'PSAPPDEVIEW',
  name: 'hr_departmentmulti_data_view',
  id: 'ibizodooapp.hr_department_multi_data_view',
};
