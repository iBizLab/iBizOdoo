export default {
  ...
  caption: '权限组关联统一资源',
  codeName: 'unires_group_rel_edit_view',
  ...
  controls: [
    ...
    },
    {
      ...
      name: 'form',
      id: 'ibizodooapp.unires_group_rel.main',
    },
    {
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: 'fb5e0e6f41b1c3d06a48517f57cafa21',
  modelType: 'PSAPPDEVIEW',
  name: 'unires_group_relEditView',
  id: 'ibizodooapp.unires_group_rel_edit_view',
};
