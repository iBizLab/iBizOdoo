export default {
  ...
  caption: '工作细节',
  codeName: 'resource_calendar_attendance_grid_view_nested',
  appDataEntityId: 'ibizodooapp.resource_calendar_attendance',
  viewLayoutPanel: {
    layoutBodyOnly: true,
    viewProxyMode: true,
    layoutMode: 'FLEX',
    ...
    appViewLogics: [
      {
        ...
        builtinAppUILogic: {
          ...
          newDataAppView: {
            refAppViewId: 'ibizodooapp.resource_calendar_attendance_edit_view',
          },
          appUILogicRefViews: [
            {
              refAppViewId:
                'ibizodooapp.resource_calendar_attendance_edit_view',
            },
          ],
          builtinLogic: true,
    ...
    controls: [
      {
        ...
        degridColumns: [
          ...
          },
          {
            ...
            excelCaption: '星期',
            appCodeListId:
              'ibizodooapp.resource__resource_calendar_attendance_dayofweek',
          ...
          },
          {
            ...
            excelCaption: '日期',
            appCodeListId:
              'ibizodooapp.resource__resource_calendar_attendance_day_period',
          ...
          },
          {
            ...
            excelCaption: '周数',
            appCodeListId:
              'ibizodooapp.resource__resource_calendar_attendance_week_type',
        ...
        modelType: 'PSDEGRID',
        name: 'grid',
        id: 'ibizodooapp.resource_calendar_attendance.edit_main',
      },
      {
        detoolbarItems: [
          {
        ...
        xdataControlName: 'grid',
        codeName: 'grid_view_nested_toolbar',
        controlType: 'TOOLBAR',
      ...
      },
      {
        ...
        name: 'searchform',
        id: 'ibizodooapp.resource_calendar_attendance.main2',
      },
      {
        groupMode: 'SINGLE',
      ...
      },
      {
        ...
        caption: '工作细节',
        codeName: 'grid_view_nested_captionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'ibizodooapp.resource_calendar_attendance',
        controlParam: {},
        name: 'captionbar',
        id: 'grid_view_nested_captionbar',
      },
    ],
  ...
  modelId: 'ab8f440b9d3e7f31f78335872ffb2203',
  modelType: 'PSAPPDEVIEW',
  name: 'resource_calendar_attendancegrid_view_nested',
  id: 'ibizodooapp.resource_calendar_attendance_grid_view_nested',
};
