export default {
  ...
  loadDefault: true,
  deviewCodeName: 'discuss_inbox_list_view',
  deviewId: '0c313407700ddd811391b2ebd8c41574',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'PAGE.CAPTION.MAIL_MESSAGE.DISCUSS_INBOX_LIST_VIEW',
  },
  caption: '收件箱',
  ...
  controls: [
    ...
    },
    {
      ...
      codeName: 'discuss_inbox_list_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'ibizodooapp.mail_message',
      controlParam: {},
      name: 'captionbar',
      id: 'discuss_inbox_list_view_captionbar',
    },
  ],
  sysImage: {
    cssClass: 'fa fa-inbox',
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: 'e8f33a116352138f95ff558bfbd6baa9',
  modelType: 'PSAPPDEVIEW',
  name: 'mail_messagediscuss_inbox_list_view',
