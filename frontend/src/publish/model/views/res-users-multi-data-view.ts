export default {
  ...
  caption: '用户',
  codeName: 'res_users_multi_data_view',
    ...
    appViewLogics: [
      {
        ...
        builtinAppUILogic: {
          ...
          newDataAppView: {
            refAppViewId: 'ibizodooapp.res_users_main_view',
          },
          appUILogicRefViews: [
            {
              refAppViewId: 'ibizodooapp.res_users_main_view',
    ...
    controls: [
      ...
      },
      {
        ...
        itemLayoutPanel: {
          ...
          id: 'ibizodooapp.res_users.ac4170309f5404289b4',
        },
        dedataViewDataItems: [
          {
            appDEFieldId: 'id',
        ...
        name: 'dataview',
        id: 'ibizodooapp.res_users.user_info',
      },
      {
        groupMode: 'AND',
        searchBarGroups: [
        ...
        name: 'searchbar',
        id: 'ibizodooapp.res_users.search_bar',
      },
      {
        detoolbarItems: [
          {
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: 'b3f36aa3991a5bb4d33f481734c01ed0',
  modelType: 'PSAPPDEVIEW',
  name: 'res_usersmulti_data_view',
  id: 'ibizodooapp.res_users_multi_data_view',
};
