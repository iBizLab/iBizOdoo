export default {
  ...
  deviewId: '7a29c0a9c571e65604cf218f0cc2cca9',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.MAIL_TEMPLATE',
  },
  caption: 'EMail模板',
  codeName: 'mail_template_multi_data_view',
    ...
    appViewLogics: [
      {
        ...
        builtinAppUILogic: {
          ...
          newDataAppView: {
            refAppViewId: 'ibizodooapp.mail_template_main_view',
          },
          appUILogicRefViews: [
            {
              refAppViewId: 'ibizodooapp.mail_template_main_view',
    ...
    controls: [
      {
        ...
        searchBarGroups: [
          {
            caption: '我的模板',
            data: '{"theme_model":{"searchconds":[{"condtype":"GROUP","condop":"AND","bnotmode":false,"searchconds":[{"condtype":"DEFIELD","fieldname":"user_id","condop":"EQ","value":"${context.srfpartnerid}"}]}]}}',
            itemType: 'GROUP',
            id: 'my_template',
          },
          {
            defaultGroup: true,
            caption: '基础模板',
            data: '{"theme_model":{"searchconds":[{"condtype":"GROUP","condop":"AND","bnotmode":false,"searchconds":[{"condtype":"DEFIELD","fieldname":"template_category","condop":"EQ","value":"base_template"}]}]}}',
            itemType: 'GROUP',
            id: 'base_template',
          },
          {
            addSeparator: true,
            caption: '自定义模板',
            data: '{"theme_model":{"searchconds":[{"condtype":"GROUP","condop":"AND","bnotmode":false,"searchconds":[{"condtype":"DEFIELD","fieldname":"template_category","condop":"EQ","value":"custom_template"}]}]}}',
            itemType: 'GROUP',
            id: 'custom_template',
          },
        ],
        ...
        logicName: 'EMail模板搜索栏',
        appDataEntityId: 'ibizodooapp.mail_template',
        controlParam: {
          id: 'searchbar',
        },
        sysPFPluginId: 'odoo_search_bar',
        modelId: '94f242a45b4dd544ae7e9a8dac56b33b',
        modelType: 'PSSYSSEARCHBAR',
        name: 'searchbar',
        id: 'ibizodooapp.mail_template.search_bar',
      },
      {
        detoolbarItems: [
          {
        ...
        controlType: 'TOOLBAR',
        logicName: 'EMail模板实体管理视图_工具栏',
        appDataEntityId: 'ibizodooapp.mail_template',
        controlParam: {
          id: 'toolbar',
        },
        modelId: 'f484ac114a648ea75c930de21e2ccb1a',
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '28b08b8e4b8c3c05e8445025ec5e67b0',
  modelType: 'PSAPPDEVIEW',
  name: 'mail_templatemulti_data_view',
  id: 'ibizodooapp.mail_template_multi_data_view',
};
