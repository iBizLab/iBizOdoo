export default {
  ...
  deviewId: 'c6380dc0ef1e37f5baf6929a992d0995',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.IR_CRON_TRIGGER',
  },
  caption: '计划行动触发器',
  codeName: 'ir_cron_trigger_multi_data_view',
  ...
  viewLayoutPanel: {
    ...
    appViewLogics: [
      {
        ...
        builtinAppUILogic: {
          ...
          newDataAppView: {
            refAppViewId: 'ibizodooapp.ir_cron_trigger_main_view',
          },
          appUILogicRefViews: [
            {
              refAppViewId: 'ibizodooapp.ir_cron_trigger_main_view',
    ...
    controls: [
      ...
      },
      {
        ...
        modelId: '074b87fc6d0bfaaab3e5a1e9d8abf10b',
        modelType: 'PSSYSSEARCHBAR',
        name: 'searchbar',
        id: 'ibizodooapp.ir_cron_trigger.search_bar',
      },
      {
        aggMode: 'NONE',
        ...
        modelId: '454fdd78e91981432c4483faa39c8396',
        modelType: 'PSDEGRID',
        name: 'grid',
        id: 'ibizodooapp.ir_cron_trigger.main',
      },
      {
        capLanguageRes: {
          lanResTag: 'DE.LNAME.IR_CRON_TRIGGER',
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: 'e8be2733eea0e7380b604483216819de',
  modelType: 'PSAPPDEVIEW',
  name: 'ir_cron_triggermulti_data_view',
  id: 'ibizodooapp.ir_cron_trigger_multi_data_view',
};
