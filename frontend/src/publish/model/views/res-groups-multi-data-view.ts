export default {
  ...
  caption: '群组',
  codeName: 'res_groups_multi_data_view',
  ...
  viewLayoutPanel: {
    ...
    controls: [
      ...
      },
      {
        ...
        name: 'searchbar',
        id: 'ibizodooapp.res_groups.search_bar',
      },
      {
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '25ec5087d95caedb50112046e33493ce',
  modelType: 'PSAPPDEVIEW',
  name: 'res_groupsmulti_data_view',
  id: 'ibizodooapp.res_groups_multi_data_view',
};
