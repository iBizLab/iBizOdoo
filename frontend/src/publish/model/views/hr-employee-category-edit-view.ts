export default {
  ...
  deviewId: '3d7f17f9e0fbe701c4ae3183b2505a5b',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.HR_EMPLOYEE_CATEGORY',
  },
  caption: '员工类别',
  codeName: 'hr_employee_category_edit_view',
  ...
  controls: [
    ...
    },
    {
      ...
      deformPages: [
        {
          ...
          deformDetails: [
            {
              ...
              capLanguageRes: {
                lanResTag:
                  'CONTROL.DEFORM.HR_EMPLOYEE_CATEGORY.MAIN.GROUPPANEL.GROUP1',
              },
              caption: '员工类别基本信息',
              codeName: 'group1',
              detailStyle: 'DEFAULT',
            ...
            },
            {
              ...
              hidden: true,
              capLanguageRes: {
                lanResTag: 'DEF.LNAME.HR_EMPLOYEE_CATEGORY.ID',
              },
              caption: '标识',
              codeName: 'id',
              detailStyle: 'DEFAULT',
          ...
          capLanguageRes: {
            lanResTag:
              'CONTROL.DEFORM.HR_EMPLOYEE_CATEGORY.MAIN.FORMPAGE.FORMPAGE1',
          },
          caption: '基本信息',
          codeName: 'formpage1',
          detailStyle: 'DEFAULT',
        ...
        },
        {
          ...
          deformDetails: [
            {
              ...
              capLanguageRes: {
                lanResTag:
                  'CONTROL.DEFORM.HR_EMPLOYEE_CATEGORY.MAIN.GROUPPANEL.GROUP2',
              },
              caption: '操作信息',
              codeName: 'group2',
              detailStyle: 'DEFAULT',
          ...
          capLanguageRes: {
            lanResTag:
              'CONTROL.DEFORM.HR_EMPLOYEE_CATEGORY.MAIN.FORMPAGE.FORMPAGE2',
          },
          caption: '其它',
          codeName: 'formpage2',
          detailStyle: 'DEFAULT',
      ...
      modelId: '8dbad583f847c373cb3a650e284951bf',
      modelType: 'PSDEFORM_EDITFORM',
      name: 'form',
      id: 'ibizodooapp.hr_employee_category.main',
    },
    {
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '0132b0053674f68f9968468f3e897b57',
  modelType: 'PSAPPDEVIEW',
  name: 'hr_employee_categoryEditView',
  id: 'ibizodooapp.hr_employee_category_edit_view',
};
