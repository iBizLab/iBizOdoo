export default {
  ...
  deviewId: '9127a3501b9b33382ea0e251a2aaf081',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'PAGE.CAPTION.HR_EMPLOYEE_CATEGORY.MULTI_DATA_VIEW',
  },
  caption: '员工标签',
  codeName: 'hr_employee_category_multi_data_view',
  appDataEntityId: 'ibizodooapp.hr_employee_category',
  viewLayoutPanel: {
    viewProxyMode: true,
    layoutMode: 'FLEX',
    layout: {
    ...
    appViewLogics: [
      {
        ...
        builtinAppUILogic: {
          ...
          newDataAppView: {
            refAppViewId: 'ibizodooapp.hr_employee_category_edit_view',
          },
          appUILogicRefViews: [
            {
              refAppViewId: 'ibizodooapp.hr_employee_category_edit_view',
    ...
    controls: [
      {
        ...
        degridColumns: [
          {
            ...
            align: 'LEFT',
            capLanguageRes: {
              lanResTag: 'DEF.LNAME.HR_EMPLOYEE_CATEGORY.NAME',
            },
            caption: '员工标签',
            codeName: 'name',
        ...
        modelId: '14292c8c609591b2c028a99995cd4ee8',
        modelType: 'PSDEGRID',
        name: 'grid',
        id: 'ibizodooapp.hr_employee_category.edit_main',
      },
      {
        groupMode: 'AND',
        quickGroupCount: 1,
        ...
        modelId: '8da53d39683148e1d3988757653e7806',
        modelType: 'PSSYSSEARCHBAR',
        name: 'searchbar',
        id: 'ibizodooapp.hr_employee_category.search_bar',
      },
      {
        detoolbarItems: [
          {
        ...
        controlType: 'TOOLBAR',
        logicName: '员工类别实体管理视图_工具栏',
        appDataEntityId: 'ibizodooapp.hr_employee_category',
        controlParam: {
          id: 'toolbar',
        },
        modelId: '9d1d61fb3dcc6d9f678bb3ce76892985',
  ...
  title: '员工类别',
  titleLanguageRes: {
    lanResTag: 'PAGE.TITLE.HR_EMPLOYEE_CATEGORY.MULTI_DATA_VIEW',
  },
  viewStyle: 'DEFAULT',
  viewType: 'DEMDCUSTOMVIEW',
  enableDP: true,
  showCaptionBar: true,
  modelId: '77cb2c910bfbf3bc320a83595fd68809',
  modelType: 'PSAPPDEVIEW',
  name: 'hr_employee_categorymulti_data_view',
  id: 'ibizodooapp.hr_employee_category_multi_data_view',
};
