export default {
  ...
  deviewId: '55e04fdc2c6ffceb437ac654733d758b',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.RULE_GROUP_REL',
  },
  caption: '权限组关联规则',
  codeName: 'rule_group_rel_edit_view',
  ...
  controls: [
    ...
    },
    {
      ...
      deformPages: [
        {
          ...
          deformDetails: [
            {
              ...
              capLanguageRes: {
                lanResTag:
                  'CONTROL.DEFORM.RULE_GROUP_REL.MAIN.GROUPPANEL.GROUP1',
              },
              caption: '权限组关联规则基本信息',
              codeName: 'group1',
              detailStyle: 'DEFAULT',
          ...
          capLanguageRes: {
            lanResTag: 'CONTROL.DEFORM.RULE_GROUP_REL.MAIN.FORMPAGE.FORMPAGE1',
          },
          caption: '基本信息',
          codeName: 'formpage1',
          detailStyle: 'DEFAULT',
        ...
        },
        {
          ...
          deformDetails: [
            {
              ...
              capLanguageRes: {
                lanResTag:
                  'CONTROL.DEFORM.RULE_GROUP_REL.MAIN.GROUPPANEL.GROUP2',
              },
              caption: '操作信息',
              codeName: 'group2',
              detailStyle: 'DEFAULT',
          ...
          capLanguageRes: {
            lanResTag: 'CONTROL.DEFORM.RULE_GROUP_REL.MAIN.FORMPAGE.FORMPAGE2',
          },
          caption: '其它',
          codeName: 'formpage2',
          detailStyle: 'DEFAULT',
      ...
      modelId: '9cf5b8faf490e1a50e5d377f325cdf4c',
      modelType: 'PSDEFORM_EDITFORM',
      name: 'form',
      id: 'ibizodooapp.rule_group_rel.main',
    },
    {
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: 'c4a17fcb7da4f06cfdae9150bbb06f48',
  modelType: 'PSAPPDEVIEW',
  name: 'rule_group_relEditView',
  id: 'ibizodooapp.rule_group_rel_edit_view',
};
