export default {
  ...
  deviewId: 'a5bc589cbf0a979c2b271e4b7f14af46',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.MAIL_MESSAGE',
  },
  caption: '消息',
  codeName: 'mail_message_multi_data_view',
    ...
    appViewLogics: [
      {
        ...
        builtinAppUILogic: {
          ...
          newDataAppView: {
            refAppViewId: 'ibizodooapp.mail_message_main_view',
          },
          appUILogicRefViews: [
            {
              refAppViewId: 'ibizodooapp.mail_message_main_view',
    ...
    controls: [
      {
        ...
        searchBarGroups: [
          {
            addSeparator: true,
            caption: '提及',
            data: '{"theme_model":{"searchconds":[{"condtype":"GROUP","condop":"OR","bnotmode":false,"searchconds":[]}]}}',
            itemType: 'GROUP',
            id: 'all',
          },
          {
            addSeparator: true,
            caption: '需要行动',
            data: '{"theme_model":{"searchconds":[{"condtype":"GROUP","condop":"AND","bnotmode":false,"searchconds":[{"condtype":"DEFIELD","fieldname":"needaction","condop":"EQ","value":"1"}]}]}}',
            itemType: 'GROUP',
            id: 'needaction',
          },
        ],
        ...
        modelId: 'dbc175fc3a914f778d85defbb80a0894',
        modelType: 'PSSYSSEARCHBAR',
        name: 'searchbar',
        id: 'ibizodooapp.mail_message.search_bar',
      },
      {
        detoolbarItems: [
          {
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: 'c2d85188882b9544a607d34d16643a4b',
  modelType: 'PSAPPDEVIEW',
  name: 'mail_messagemulti_data_view',
  id: 'ibizodooapp.mail_message_multi_data_view',
};
