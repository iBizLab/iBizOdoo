export default {
  appDEFields: [
    ...
    },
    {
      codeName: 'color',
      lnlanguageRes: {
        lanResTag: 'DEF.LNAME.HR_EMPLOYEE_CATEGORY.COLOR',
      },
      logicName: '颜色指标',
      predefinedType: 'NONE',
      stdDataType: 9,
    ...
    },
    {
      ...
      lnlanguageRes: {
        lanResTag: 'DEF.LNAME.HR_EMPLOYEE_CATEGORY.DISPLAY_NAME',
      },
      logicName: '显示名称',
      predefinedType: 'NONE',
      stdDataType: 25,
  ...
  appDEMethodDTOs: [
    {
      codeName: 'hr_employee_category_dto',
      ...
      sourceType: 'DE',
      type: 'DEFAULT',
      id: 'hr_employee_category_dto',
    },
    {
      codeName: 'hr_employee_category_filter_dto',
      appDEMethodDTOFields: [
        {
          codeName: 'n_id_eq',
          logicName: '标识',
      ...
      sourceType: 'DE',
      type: 'DEFILTER',
      id: 'hr_employee_category_filter_dto',
    },
  ],
  appDEMethods: [
    {
      ...
      methodType: 'DEACTION',
      appDEMethodInput: {
        appDEMethodDTOId: 'hr_employee_category_dto',
        type: 'DTO',
        id: '输入对象',
      },
      appDEMethodReturn: {
    ...
    },
    {
      ...
      methodType: 'FETCH',
      appDEMethodInput: {
        appDEMethodDTOId: 'hr_employee_category_filter_dto',
        type: 'DTO',
        id: '输入对象',
      },
      appDEMethodReturn: {
  ...
  deapicodeName: 'hr_employee_category',
  deapicodeName2: 'hr_employee_categories',
  deapitag: 'HR_EMPLOYEE_CATEGORY',
  dataAccCtrlArch: 1,
  dataAccCtrlMode: 1,
  enableUIActions: 15,
  keyAppDEFieldId: 'id',
  ...
  id: 'ibizodooapp.hr_employee_category',
  codeName2: 'hr_employee_categories',
  requestPaths: [],
};
