export default {
  appDEFields: [
    ...
    },
    {
      codeName: 'name',
      lnlanguageRes: {
        lanResTag: 'DEF.LNAME.CRM_STAGE.NAME',
      },
      logicName: '名称',
      predefinedType: 'NONE',
      stdDataType: 25,
    ...
    },
    {
      codeName: 'id',
      lnlanguageRes: {
        lanResTag: 'DEF.LNAME.CRM_STAGE.ID',
      },
      logicName: '标识',
      predefinedType: 'NONE',
      stdDataType: 25,
    ...
    },
    {
      codeName: 'is_won',
      lnlanguageRes: {
        lanResTag: 'DEF.LNAME.CRM_STAGE.IS_WON',
      },
      logicName: '是赢得阶段？',
      predefinedType: 'NONE',
      stdDataType: 9,
    ...
    },
    {
      codeName: 'fold',
      lnlanguageRes: {
        lanResTag: 'DEF.LNAME.CRM_STAGE.FOLD',
      },
      logicName: '在渠道中折叠',
      predefinedType: 'NONE',
      stdDataType: 9,
    ...
    },
    {
      codeName: 'sequence',
      lnlanguageRes: {
        lanResTag: 'DEF.LNAME.CRM_STAGE.SEQUENCE',
      },
      logicName: '序号',
      predefinedType: 'NONE',
      stdDataType: 9,
    ...
    },
    {
      ...
      lnlanguageRes: {
        lanResTag: 'DEF.LNAME.CRM_STAGE.REQUIREMENTS',
      },
      logicName: '要求',
      predefinedType: 'NONE',
      stdDataType: 21,
    ...
    },
    {
      codeName: 'team_id',
      lnlanguageRes: {
        lanResTag: 'DEF.LNAME.CRM_STAGE.TEAM_ID',
      },
      logicName: '销售团队',
      predefinedType: 'NONE',
      stdDataType: 25,
    ...
    },
    {
      codeName: 'team_count',
      lnlanguageRes: {
        lanResTag: 'DEF.LNAME.CRM_STAGE.TEAM_COUNT',
      },
      logicName: 'team_count',
      predefinedType: 'NONE',
      stdDataType: 9,
      name: 'TEAM_COUNT',
      id: 'team_count',
    },
    {
      ...
      lnlanguageRes: {
        lanResTag: 'DEF.LNAME.CRM_STAGE.DISPLAY_NAME',
      },
      logicName: '显示名称',
      predefinedType: 'NONE',
      stdDataType: 25,
  ...
  appDEMethods: [
    {
      ...
      methodType: 'DEACTION',
      appDEMethodInput: {
        appDEMethodDTOId: 'crm_stage_dto',
        type: 'DTO',
        id: '输入对象',
      },
      appDEMethodReturn: {
    ...
    },
    {
      ...
      methodType: 'FETCH',
      appDEMethodInput: {
        appDEMethodDTOId: 'crm_stage_filter_dto',
        type: 'DTO',
        id: '输入对象',
      },
      appDEMethodReturn: {
  ...
  codeName: 'crm_stage',
  deapicodeName: 'crm_stage',
  deapicodeName2: 'crm_stages',
  deapitag: 'CRM_STAGE',
  dataAccCtrlArch: 1,
  dataAccCtrlMode: 1,
  enableUIActions: 15,
  ...
  major: true,
  name: 'CRM_STAGE',
  id: 'ibizodooapp.crm_stage',
  codeName2: 'crm_stages',
  requestPaths: [],
};
