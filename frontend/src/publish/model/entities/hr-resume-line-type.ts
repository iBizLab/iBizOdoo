export default {
  appDEFields: [
    ...
    },
    {
      codeName: 'sequence',
      lnlanguageRes: {
        lanResTag: 'DEF.LNAME.HR_RESUME_LINE_TYPE.SEQUENCE',
      },
      logicName: '序列',
    ...
    },
    {
      ...
      lnlanguageRes: {
        lanResTag: 'DEF.LNAME.HR_RESUME_LINE_TYPE.DISPLAY_NAME',
      },
      logicName: '显示名称',
      predefinedType: 'NONE',
      stdDataType: 25,
  ...
  appDEMethodDTOs: [
    {
      codeName: 'hr_resume_line_type_dto',
      ...
      sourceType: 'DE',
      type: 'DEFAULT',
      id: 'hr_resume_line_type_dto',
    },
    {
      codeName: 'hr_resume_line_type_filter_dto',
      appDEMethodDTOFields: [
        {
          codeName: 'n_id_eq',
          logicName: '标识',
      ...
      sourceType: 'DE',
      type: 'DEFILTER',
      id: 'hr_resume_line_type_filter_dto',
    },
  ],
  appDEMethods: [
    {
      ...
      methodType: 'DEACTION',
      appDEMethodInput: {
        appDEMethodDTOId: 'hr_resume_line_type_dto',
        type: 'DTO',
        id: '输入对象',
      },
      appDEMethodReturn: {
    ...
    },
    {
      ...
      methodType: 'FETCH',
      appDEMethodInput: {
        appDEMethodDTOId: 'hr_resume_line_type_filter_dto',
        type: 'DTO',
        id: '输入对象',
      },
      appDEMethodReturn: {
  ...
  deapicodeName: 'hr_resume_line_type',
  deapicodeName2: 'hr_resume_line_types',
  deapitag: 'HR_RESUME_LINE_TYPE',
  dataAccCtrlArch: 1,
  dataAccCtrlMode: 1,
  enableUIActions: 15,
  keyAppDEFieldId: 'id',
  ...
  id: 'ibizodooapp.hr_resume_line_type',
  codeName2: 'hr_resume_line_types',
  requestPaths: [],
};
