export default {
  appDEFields: [
    ...
    },
    {
      codeName: 'sequence',
      lnlanguageRes: {
        lanResTag: 'DEF.LNAME.HR_CONTRACT_TYPE.SEQUENCE',
      },
      logicName: '序列',
    ...
    },
    {
      ...
      lnlanguageRes: {
        lanResTag: 'DEF.LNAME.HR_CONTRACT_TYPE.DISPLAY_NAME',
      },
      logicName: '显示名称',
      predefinedType: 'NONE',
      stdDataType: 25,
  ...
  appDEMethodDTOs: [
    {
      ...
      sourceType: 'DE',
      type: 'DEFAULT',
      id: 'hr_contract_type_dto',
    },
    {
      codeName: 'hr_contract_type_filter_dto',
      appDEMethodDTOFields: [
        {
      ...
      sourceType: 'DE',
      type: 'DEFILTER',
      id: 'hr_contract_type_filter_dto',
    },
  ],
  appDEMethods: [
    {
      ...
      methodType: 'DEACTION',
      appDEMethodInput: {
        appDEMethodDTOId: 'hr_contract_type_dto',
        type: 'DTO',
        id: '输入对象',
      },
      appDEMethodReturn: {
    ...
    },
    {
      ...
      methodType: 'FETCH',
      appDEMethodInput: {
        appDEMethodDTOId: 'hr_contract_type_filter_dto',
        type: 'DTO',
        id: '输入对象',
      },
      appDEMethodReturn: {
  ...
  deapicodeName: 'hr_contract_type',
  deapicodeName2: 'hr_contract_types',
  deapitag: 'HR_CONTRACT_TYPE',
  dataAccCtrlArch: 1,
  dataAccCtrlMode: 1,
  enableUIActions: 15,
  keyAppDEFieldId: 'id',
  ...
  id: 'ibizodooapp.hr_contract_type',
  codeName2: 'hr_contract_types',
  requestPaths: [],
};
