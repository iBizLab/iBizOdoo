export default {
  ...
  appDEMethodDTOs: [
    {
      ...
      appDEMethodDTOFields: [
        ...
        {
          codeName: 'mail_tracking_values',
          refAppDEDataSetId: 'fetch_default',
          refAppDEMethodDTOId: 'mail_tracking_value_dto',
          refAppDataEntityId: 'ibizodooapp.mail_tracking_value',
          refPickupAppDEFieldId: 'mail_message_id',
          sourceType: 'DER',
          type: 'DTOS',
          allowEmpty: true,
          id: 'mail_tracking_values',
        },
      ],
      sourceType: 'DE',
      type: 'DEFAULT',
    ...
    },
    {
      ...
      appDEMethodDTOFields: [
        ...
        },
        {
          ...
          type: 'SIMPLE',
          allowEmpty: true,
          id: 'n_subtype_name_eq',
        },
        {
          codeName: 'n_subtype_name_like',
          logicName: '子类型',
          appDEFieldId: 'subtype_name',
          sourceType: 'DEFSEARCHMODE',
          stdDataType: 25,
  ...
  appDEUIActions: [
    {
      ...
      caption: '收藏',
      codeName: 'add_favorite',
      fullCodeName: 'mail_message_add_favorite',
      appDEMethodId: 'add_favorite',
      sysImage: {
        rawContent:
    ...
    },
    {
      ...
      buttonStyle: 'DEFAULT',
      caption: '编辑',
      codeName: 'panel_channel_message_layout_button_calluilogic1_click',
      frontProcessType: 'OTHER',
      fullCodeName:
        'mail_message_panel_channel_message_layout_button_calluilogic1_click',
      uiactionMode: 'FRONT',
      uiactionTag: 'panel_channel_message_layout_button_calluilogic1_click',
      uiactionType: 'DEUIACTION',
      uilogicAttachMode: 'REPLACE',
      uilogicType: 'DELOGIC',
      showBusyIndicator: true,
      ...
      appDataEntityId: 'ibizodooapp.mail_message',
      name: '编辑',
      id: 'panel_channel_message_layout_button_calluilogic1_click@mail_message',
    },
    {
      actionLevel: 100,
      actionTarget: 'SINGLEDATA',
      buttonStyle: 'DEFAULT',
      caption: '回复',
      codeName: 'panel_channel_message_layout_button_calluilogic2_click',
      frontProcessType: 'OTHER',
      fullCodeName:
        'mail_message_panel_channel_message_layout_button_calluilogic2_click',
      uiactionMode: 'FRONT',
      uiactionTag: 'panel_channel_message_layout_button_calluilogic2_click',
      uiactionType: 'DEUIACTION',
      uilogicAttachMode: 'REPLACE',
      uilogicType: 'DELOGIC',
      showBusyIndicator: true,
      ...
      appDataEntityId: 'ibizodooapp.mail_message',
      name: '回复',
      id: 'panel_channel_message_layout_button_calluilogic2_click@mail_message',
    },
    {
      actionLevel: 100,
      actionTarget: 'SINGLEDATA',
    ...
    },
    {
      ...
      caption: '取消收藏',
      codeName: 'remove_favorite',
      fullCodeName: 'mail_message_remove_favorite',
      ...
      appDataEntityId: 'ibizodooapp.mail_message',
      name: '取消收藏',
      id: 'remove_favorite@mail_message',
    },
    {
      actionLevel: 100,
      actionTarget: 'NONE',
    ...
    },
    {
      ...
      caption: '取消置顶',
      codeName: 'unpin',
      confirmMsg: '是否取消置顶该消息',
      fullCodeName: 'mail_message_unpin',
      appDEMethodId: 'unpin',
      sysImage: {
        cssClass: 'fa fa-thumb-tack',
        glyph: 'xf08d@FontAwesome',
    ...
    },
    {
      ...
      deuilogicNodes: [
        ...
        },
        {
          ...
          dstAppDataEntityId: 'ibizodooapp.mail_message',
          codeName: 'DEACTION2',
          dstDEUILogicParamId: 'comment',
          leftPos: 586,
        ...
        },
        {
          ...
          dstAppDataEntityId: 'ibizodooapp.mail_thread',
  ...
  quickSearchAppDEFieldIds: ['record_name'],
  sysAPITag: 'ServiceAPI',
  defaultMode: true,
  enableFilterActions: true,
  major: true,
  name: 'MAIL_MESSAGE',
  id: 'ibizodooapp.mail_message',
