...
##### 分配类别 :id=hr_leave_allocation_generate_multi_wizard_allocation_type
...
##### 合同状态 :id=hr_contract_history_under_contract_state
...
|sms_invalid_destination|无效目的地|sms_invalid_destination||
...
##### 工作位置类型 :id=hr_employee_public_work_location_type
...
##### 年 月 :id=hr_leave_accrual_level_yearly_month
...
##### 活动异常标示 :id=crm_lead_activity_exception_decoration
...
##### 活动状态 :id=hr_contract_activity_state
...
##### 用户类型 :id=ir_actions_server_activity_user_type
...
##### 电话号码质量 :id=crm_lead_phone_state
...
##### 看板状态 :id=hr_contract_kanban_state
...
##### 筛选于 :id=crm_iap_lead_mining_request_contact_filter_type
...
##### 类型 :id=crm_iap_lead_mining_request_lead_type
...
##### 结转 :id=hr_leave_accrual_level_action_with_unused_accruals
...
##### 自动分配间隔单位 :id=res_config_settings_crm_auto_assignment_interval_type
...
##### 表单状态 :id=hr_applicant_application_status



| 值col150        |    文本col150    |   代码名col150    |  备注col800     |
| --------   |------------|------------|------------|
|ongoing|正在进行|ongoing||
|hired|被雇佣的|hired||
|refused|已拒绝|refused||
...
##### 许可证 :id=ir_module_module_license



| 值col150        |    文本col150    |   代码名col150    |  备注col800     |
| --------   |------------|------------|------------|
|GPL-2|GPL 版本 2|gpl_SUB_2||
|GPL-2 or any later version|GPL-2 或更高版本|gpl_SUB_2_or_any_later_version||
|GPL-3|GPL第3版|gpl_SUB_3||
|GPL-3 or any later version|GPL-3或更高版本|gpl_SUB_3_or_any_later_version||
|AGPL-3|Affero GPL-3|agpl_SUB_3||
|LGPL-3|LGPL 版本 3|lgpl_SUB_3||
|Other OSI approved licence|OSI 批准的其他许可证|other_osi_approved_licence||
|OEEL-1|ERP 企业版授权协议 v1.0|oeel_SUB_1||
|OPL-1|Proprietary License v1.0|opl_SUB_1||
|Other proprietary|其它所有权|other_proprietary||

##### 设备类型 :id=res_device_device_type
...
##### 设备类型 :id=res_device_log_device_type
...
##### 账单管理 :id=res_config_settings_default_purchase_method



| 值col150        |    文本col150    |   代码名col150    |  备注col800     |
| --------   |------------|------------|------------|
|purchase|订购数量|purchase||
|receive|收到数量|receive||
...
##### 连接加密 :id=ir_mail_server_smtp_encryption
...
| --------   |------------|------------|------------|
|none|无|none||
|starttls|TLS (STARTTLS)|starttls||
|ssl|SSL / TLS|ssl||

##### 选择休假类别 :id=hr_holidays_summary_employee_holiday_type
...
##### 通知类型 :id=mail_notification_notification_type
...
##### 里程碑式的过渡 :id=hr_leave_accrual_plan_transition_mode



| 值col150        |    文本col150    |   代码名col150    |  备注col800     |
| --------   |------------|------------|------------|
|immediately|马上|immediately||
|end_of_accrual|在这个应计的时期之后|end_of_accrual||

##### 重量单位 :id=res_config_settings_product_weight_in_lbs
...
##### 错误类型 :id=crm_iap_lead_mining_request_error_type



| 值col150        |    文本col150    |   代码名col150    |  备注col800     |
| --------   |------------|------------|------------|
|credits|信用不足|credits||
|no_result|没有结果|no_result||

##### 间隔单位 :id=ir_cron_interval_type
...
##### 附加值类型 :id=hr_leave_accrual_plan_added_value_type
...
##### 附加值类型 :id=hr_leave_accrual_level_added_value_type
...
##### 频率 :id=hr_leave_accrual_level_frequency
...
|daily|每天|daily||
|weekly|每周|weekly||
|bimonthly|一个月两次|bimonthly||
|monthly|每月|monthly||
|biyearly|每年两次|biyearly||
|yearly|每年|yearly||

##### 频率 每小时 来源 :id=hr_leave_accrual_level_frequency_hourly_source
...
##### 验证 :id=ir_mail_server_smtp_authentication
...
| --------   |------------|------------|------------|
|login|用户名|login||
|certificate|SSL 安全证书|certificate||
|cli|命令行界面|cli||
|gmail|Gmail OAuth身份验证|gmail||
