# 电子邮件副本管理(mail_thread_cc)  <!-- {docsify-ignore-all} -->
...
##### 导航
<el-anchor >
<el-anchor-link :href="`#/module/mail/mail_thread_cc?id=属性`">
  属性
</el-anchor-link>
<el-anchor-link :href="`#/module/mail/mail_thread_cc?id=行为`">
  行为
</el-anchor-link>
<el-anchor-link :href="`#/module/mail/mail_thread_cc?id=搜索模式`">
  搜索模式
</el-anchor-link>
</el-anchor>
</div>
