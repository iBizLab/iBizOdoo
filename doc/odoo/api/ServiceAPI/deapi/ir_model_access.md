...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/res_groups/{pkey}/ir_model_accesses" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/res_groups/{pkey}/ir_model_accesses/{key}" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/res_groups/{pkey}/ir_model_accesses/check_key" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/res_groups/{pkey}/ir_model_accesses/get_draft" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/res_groups/{pkey}/ir_model_accesses/save" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/res_groups/{pkey}/ir_model_accesses/fetch_default" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/res_groups/{pkey}/ir_model_accesses/importtemplate" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/res_groups/{pkey}/ir_model_accesses/exportdata/{param},/res_groups/{pkey}/ir_model_accesses/exportdata/{param}/{key}" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/res_groups/{pkey}/ir_model_accesses/importdata" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/res_groups/{pkey}/ir_model_accesses/importdata2" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/res_groups/{pkey}/ir_model_accesses/asyncimportdata2" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/res_groups/{pkey}/ir_model_accesses/printdata/{key}" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/res_groups/{pkey}/ir_model_accesses/report" type="info" :closable="false" ></el-alert>
</div>
</el-row>
