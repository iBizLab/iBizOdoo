# 工作细节(resource_calendar_attendance_grid_view_nested)  <!-- {docsify-ignore-all} -->
...
### 关联视图
  * [工作细节(resource_calendar_attendance_edit_view)](app/view/resource_calendar_attendance_edit_view)
